...
try {
    ...
    if (e.getReferencedTableName().equals("users")) {
        throw new UserNotFoundException(order.customer().key());
    }
    throw e;
}
```
...
```java
public class StaleEntityException extends EntityException {
...
public interface SqlExceptionTranslator {
    ...
    /**
     * Translates a SQLException to the appropriate DatabaseException subclass.<br>
     */
...
public class PostgreSqlExceptionTranslator implements SqlExceptionTranslator {
    ...
    public DatabaseException translate(SQLException e, String sql, List<Object> params) {
        ...
        if (sqlState == null) {
            return new DatabaseException("Database error", e, null,
        ...
        return switch (sqlState) {
            ...
            case "40001", "40P01" -> new DeadlockException(e, sql, params);
            ...
            case "08000", "08003", "08006" ->
                new ConnectionException(e.getMessage(), e, sqlState);

            default -> new DatabaseException("Database error", e, sqlState,
                e.getErrorCode(), sql, params);
        };
    }

    private UniqueConstraintViolationException parseUniqueViolation(
...
// QueryTimeoutException may be retryable
public class QueryTimeoutException extends QueryException implements RetryableException {
...
User user = Retry.withBackoff(3, Duration.ofMillis(100))
    .retryOn(DeadlockException.class, QueryTimeoutException.class)
    .execute(() -> {
...
public final class Retry {
    ...
    public static RetryBuilder withBackoff(int maxAttempts, Duration initialDelay) {
        return new RetryBuilder(maxAttempts, initialDelay);
    }
    ...
    public static class RetryBuilder {
        ...
        public RetryBuilder multiplier(double multiplier) {
        ...
        @SafeVarargs
        public final RetryBuilder retryOn(Class<? extends Exception>... exceptions) {
        ...
        private boolean shouldRetry(Exception e) {
            if (e instanceof RetryableException re && re.isRetryable()) {
                return true;
            }
