...
class CodecBuilderFunction16Test {
	
	@Test
	void createWithSixteenInputs() {
		CodecBuilderFunction16<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> function =
	...
	void createWithHexadecimalString() {
		CodecBuilderFunction16<String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String> function =
			(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) -> a + b + c + d + e + f + g + h + i + j + k + l + m + n + o + p;
	...
	void createMaximumParameterRecord() {
		...
		CodecBuilderFunction16<String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, MaxData> function = MaxData::new;
