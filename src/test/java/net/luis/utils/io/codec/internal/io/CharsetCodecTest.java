...
class CharsetCodecTest {
	...
	void decodeStartNullChecks() {
		...
		assertThrows(NullPointerException.class, () -> codec.decodeStart(null, new JsonPrimitive("UTF-8")));
	}
	...
	void decodeStartWithNull() {
		...
		Result<Charset> result = codec.decodeStart(typeProvider, null);
		assertTrue(result.isError());
	...
	void decodeStartWithUTF8() {
		...
		Result<Charset> result = codec.decodeStart(typeProvider, new JsonPrimitive("UTF-8"));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithISO88591() {
		...
		Result<Charset> result = codec.decodeStart(typeProvider, new JsonPrimitive("ISO-8859-1"));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithUS_ASCII() {
		...
		Result<Charset> result = codec.decodeStart(typeProvider, new JsonPrimitive("US-ASCII"));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithUTF16() {
		...
		Result<Charset> result = codec.decodeStart(typeProvider, new JsonPrimitive("UTF-16"));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithInvalidCharset() {
		...
		Result<Charset> result = codec.decodeStart(typeProvider, new JsonPrimitive("INVALID-CHARSET"));
		assertTrue(result.isError());
