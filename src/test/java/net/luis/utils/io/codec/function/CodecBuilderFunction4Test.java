...
class CodecBuilderFunction4Test {
	
	@Test
	void createWithFourInputs() {
		CodecBuilderFunction4<String, String, String, String, String> function = (a, b, c, d) -> String.join("-", a, b, c, d);
	...
	void createWithNumbers() {
		CodecBuilderFunction4<Integer, Integer, Integer, Integer, Integer> function = (a, b, c, d) -> a * b + c * d;
	...
	void createWithComplexObject() {
		...
		CodecBuilderFunction4<String, String, Integer, String, Person> function = Person::new;
