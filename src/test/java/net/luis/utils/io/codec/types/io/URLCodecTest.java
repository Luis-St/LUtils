...
class URLCodecTest {
	...
	void decodeStartWithNull() {
		...
		Result<URL> result = codec.decodeStart(typeProvider, typeProvider.empty(), null);
		assertTrue(result.isError());
	...
	void decodeStartWithValidString() throws Exception {
		...
		Result<URL> result = codec.decodeStart(typeProvider, typeProvider.empty(), new JsonPrimitive("https://example.com"));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithURLWithPath() throws Exception {
		...
		Result<URL> result = codec.decodeStart(typeProvider, typeProvider.empty(), new JsonPrimitive("https://example.com/path/to/resource"));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithURLWithQuery() throws Exception {
		...
		Result<URL> result = codec.decodeStart(typeProvider, typeProvider.empty(), new JsonPrimitive("https://example.com?key=value"));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithFileURL() throws Exception {
		...
		Result<URL> result = codec.decodeStart(typeProvider, typeProvider.empty(), new JsonPrimitive("file:///tmp/test"));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithInvalidURL() {
		...
		Result<URL> result = codec.decodeStart(typeProvider, typeProvider.empty(), new JsonPrimitive("ht tp://invalid url"));
		assertTrue(result.isError());
	...
	void decodeStartWithNonString() {
		...
		Result<URL> result = codec.decodeStart(typeProvider, typeProvider.empty(), new JsonPrimitive(42));
		assertTrue(result.isError());
	}
