...
class CodecGroupingFunction1Test {
	
	@Test
	void createWithSingleInput() {
		CodecGroupingFunction1<String, Integer> function = String::length;
	...
	void createWithNullInput() {
		CodecGroupingFunction1<String, String> function = input -> input == null ? "null" : input.toUpperCase();
	...
	void createWithComplexLogic() {
		CodecGroupingFunction1<Integer, String> function = input -> {
			if (input < 0) {
				return "negative";
			}
			if (input == 0) {
