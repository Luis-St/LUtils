...
class LongStreamCodecTest {
	...
	void decodeStartNullChecks() {
		...
		assertThrows(NullPointerException.class, () -> codec.decodeStart(null, new JsonArray(List.of(new JsonPrimitive(1L)))));
	}
	...
	void decodeStartWithNull() {
		...
		Result<LongStream> result = codec.decodeStart(typeProvider, null);
		assertTrue(result.isError());
	...
	void decodeStartWithValidArray() {
		...
		Result<LongStream> result = codec.decodeStart(typeProvider, new JsonArray(List.of(new JsonPrimitive(1L), new JsonPrimitive(2L), new JsonPrimitive(3L))));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithEmptyArray() {
		...
		Result<LongStream> result = codec.decodeStart(typeProvider, new JsonArray(List.of()));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithSingleElement() {
		...
		Result<LongStream> result = codec.decodeStart(typeProvider, new JsonArray(List.of(new JsonPrimitive(42L))));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithLargeValues() {
		...
		Result<LongStream> result = codec.decodeStart(typeProvider, new JsonArray(List.of(new JsonPrimitive(Long.MAX_VALUE), new JsonPrimitive(Long.MIN_VALUE))));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithNonArray() {
		...
		Result<LongStream> result = codec.decodeStart(typeProvider, new JsonPrimitive(42L));
		assertTrue(result.isError());
	}
