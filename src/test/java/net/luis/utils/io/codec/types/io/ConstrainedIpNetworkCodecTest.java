...
class ConstrainedIpNetworkCodecTest {
	...
	void encodeStartWithValidConstrainedValue() {
		...
		Codec<IpNetwork<?, ?>> codec = new IpNetworkCodec().apply(config -> config.withEqualTo(expected));
	...
	void encodeStartNotEqualToConstraintViolation() {
		...
		Codec<IpNetwork<?, ?>> codec = new IpNetworkCodec().apply(config -> config.withNotEqualTo(excluded));
	...
	void encodeStartInConstraintViolation() {
		...
		Codec<IpNetwork<?, ?>> codec = new IpNetworkCodec().apply(config -> config.withIn(allowed));
	...
	void encodeStartNotInConstraintViolation() {
		...
		Codec<IpNetwork<?, ?>> codec = new IpNetworkCodec().apply(config -> config.withNotIn(excluded));
	...
	void encodeStartIpVersionConstraintViolation() {
		JsonTypeProvider typeProvider = JsonTypeProvider.INSTANCE;
		Codec<IpNetwork<?, ?>> codec = new IpNetworkCodec().apply(config -> config.withIpVersion(EnumConstraintConfig.<IpVersion>unconstrained().withEqualTo(IpVersion.IPV4)));
	...
	void encodeStartIpVersionIPv6Success() {
		JsonTypeProvider typeProvider = JsonTypeProvider.INSTANCE;
		Codec<IpNetwork<?, ?>> codec = new IpNetworkCodec().apply(config -> config.withIpVersion(EnumConstraintConfig.<IpVersion>unconstrained().withEqualTo(IpVersion.IPV6)));
		IpNetwork<?, ?> ipv6Network = IpAddresses.parseNetwork("2001:db8::/32");
	...
	void encodeStartPrefixLengthConstraintViolation() {
		JsonTypeProvider typeProvider = JsonTypeProvider.INSTANCE;
		Codec<IpNetwork<?, ?>> codec = new IpNetworkCodec().apply(config -> config.withPrefixLength(LengthConstraintConfig.UNCONSTRAINED.withEqualTo(24)));
	...
	void encodeStartPrefixLengthMinMaxConstraintViolation() {
		JsonTypeProvider typeProvider = JsonTypeProvider.INSTANCE;
		Codec<IpNetwork<?, ?>> codec = new IpNetworkCodec().apply(config -> config.withPrefixLength(LengthConstraintConfig.UNCONSTRAINED.withLengthBetween(16, 24)));
		IpNetwork<?, ?> network = IpAddresses.parseNetwork("10.0.0.0/8");
	...
	void encodeStartCanonicalSuccess() {
		JsonTypeProvider typeProvider = JsonTypeProvider.INSTANCE;
		Codec<IpNetwork<?, ?>> codec = new IpNetworkCodec().apply(IpNetworkConstraintConfig::withCanonical);
	...
	void encodeStartStringConstraintViolation() {
		JsonTypeProvider typeProvider = JsonTypeProvider.INSTANCE;
		Codec<IpNetwork<?, ?>> codec = new IpNetworkCodec().apply(config -> config.withStringConstraint(StringConstraintConfig.UNCONSTRAINED.withContains("10.")));
		IpNetwork<?, ?> network = IpAddresses.parseNetwork("192.168.1.0/24");
	...
	void encodeStartCustomConstraintViolation() {
		JsonTypeProvider typeProvider = JsonTypeProvider.INSTANCE;
		Codec<IpNetwork<?, ?>> codec = new IpNetworkCodec().apply(config -> config.withCustom(value -> Result.error("Custom validation failed")));
		IpNetwork<?, ?> network = IpAddresses.parseNetwork("192.168.1.0/24");
	...
	void encodeStartCustomConstraintSuccess() {
		JsonTypeProvider typeProvider = JsonTypeProvider.INSTANCE;
		Codec<IpNetwork<?, ?>> codec = new IpNetworkCodec().apply(config -> config.withCustom(value -> Result.success()));
		IpNetwork<?, ?> network = IpAddresses.parseNetwork("192.168.1.0/24");
