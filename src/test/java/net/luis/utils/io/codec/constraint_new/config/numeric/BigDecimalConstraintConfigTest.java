...
class BigDecimalConstraintConfigTest {
	...
	void constructWithMinGreaterThanMax() {
		assertThrows(IllegalArgumentException.class, () -> BigDecimalConstraintConfig.UNCONSTRAINED
			.withBetweenOrEqual(new BigDecimal("10"), new BigDecimal("5")));
	}

	@Test
	void constructWithEqualMinMaxExclusiveBound() {
		assertThrows(IllegalArgumentException.class, () -> BigDecimalConstraintConfig.UNCONSTRAINED
			.withBetween(new BigDecimal("5"), new BigDecimal("5")));
	}
	...
	@Test
	void withIn() {
		BigDecimalConstraintConfig config = BigDecimalConstraintConfig.UNCONSTRAINED.withIn(
	...
	@Test
	void withNotIn() {
		BigDecimalConstraintConfig config = BigDecimalConstraintConfig.UNCONSTRAINED.withNotIn(
			List.of(new BigDecimal("4"), new BigDecimal("5")));
		assertTrue(config.in().isPresent());
