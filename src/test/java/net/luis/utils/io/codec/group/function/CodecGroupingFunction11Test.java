...
class CodecGroupingFunction11Test {
	
	@Test
	void createWithElevenInputs() {
		CodecGroupingFunction11<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Double> function = (a, b, c, d, e, f, g, h, i, j, k) -> {
	...
	void createCustomRecord() {
		...
		CodecGroupingFunction11<String, String, String, String, String, String, String, String, String, String, String, Data> function = Data::new;
