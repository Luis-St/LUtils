...
class CodecGrouper11Test {
	
	record TestRecord(int field1, int field2, int field3, int field4, int field5, int field6, int field7, int field8, int field9, int field10, int field11) {}
	...
	void constructorWithValidCodecs() {
		...
		CodecGrouper11<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, TestRecord> grouper = new CodecGrouper11<>(
	...
	void constructorWithNullCodecsThrowsException() {
		...
		assertThrows(NullPointerException.class, () -> new CodecGrouper11<>(null, codec, codec, codec, codec, codec, codec, codec, codec, codec, codec));
		assertThrows(NullPointerException.class, () -> new CodecGrouper11<>(codec, null, codec, codec, codec, codec, codec, codec, codec, codec, codec));
		assertThrows(NullPointerException.class, () -> new CodecGrouper11<>(codec, codec, null, codec, codec, codec, codec, codec, codec, codec, codec));
		assertThrows(NullPointerException.class, () -> new CodecGrouper11<>(codec, codec, codec, null, codec, codec, codec, codec, codec, codec, codec));
		assertThrows(NullPointerException.class, () -> new CodecGrouper11<>(codec, codec, codec, codec, null, codec, codec, codec, codec, codec, codec));
		assertThrows(NullPointerException.class, () -> new CodecGrouper11<>(codec, codec, codec, codec, codec, null, codec, codec, codec, codec, codec));
		assertThrows(NullPointerException.class, () -> new CodecGrouper11<>(codec, codec, codec, codec, codec, codec, null, codec, codec, codec, codec));
		assertThrows(NullPointerException.class, () -> new CodecGrouper11<>(codec, codec, codec, codec, codec, codec, codec, null, codec, codec, codec));
		assertThrows(NullPointerException.class, () -> new CodecGrouper11<>(codec, codec, codec, codec, codec, codec, codec, codec, null, codec, codec));
		assertThrows(NullPointerException.class, () -> new CodecGrouper11<>(codec, codec, codec, codec, codec, codec, codec, codec, codec, null, codec));
		assertThrows(NullPointerException.class, () -> new CodecGrouper11<>(codec, codec, codec, codec, codec, codec, codec, codec, codec, codec, null));
	}
	...
	void createWithValidFunction() {
		ConfiguredCodec<Integer, TestRecord> codec = createConfiguredCodec("test", TestRecord::field1);
		CodecGrouper11<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, TestRecord> grouper = new CodecGrouper11<>(
			codec, codec, codec, codec, codec, codec, codec, codec, codec, codec, codec
		);
	...
	void equalsWithSameCodecs() {
		ConfiguredCodec<Integer, TestRecord> codec = createConfiguredCodec("test", TestRecord::field1);
		CodecGrouper11<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, TestRecord> grouper1 = new CodecGrouper11<>(
			codec, codec, codec, codec, codec, codec, codec, codec, codec, codec, codec
		);
		CodecGrouper11<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, TestRecord> grouper2 = new CodecGrouper11<>(
			codec, codec, codec, codec, codec, codec, codec, codec, codec, codec, codec
		);
	...
	void equalsWithDifferentCodecs() {
		...
		ConfiguredCodec<Integer, TestRecord> codec2 = createConfiguredCodec("test2", TestRecord::field2);
		CodecGrouper11<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, TestRecord> grouper1 = new CodecGrouper11<>(
			codec1, codec1, codec1, codec1, codec1, codec1, codec1, codec1, codec1, codec1, codec1
		);
		CodecGrouper11<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, TestRecord> grouper2 = new CodecGrouper11<>(
			codec1, codec1, codec1, codec1, codec1, codec1, codec1, codec1, codec1, codec1, codec2
		);
	...
	void toStringContainsCodecInfo() {
		...
		CodecGrouper11<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, TestRecord> grouper = new CodecGrouper11<>(codec1, codec, codec, codec, codec, codec, codec, codec, codec, codec, codec11);
		
		String result = grouper.toString();
		
		assertTrue(result.contains("Codec["));
		assertTrue(result.contains("test1"));
		assertTrue(result.contains("test11"));
	}
}
