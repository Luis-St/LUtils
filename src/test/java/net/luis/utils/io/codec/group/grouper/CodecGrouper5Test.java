...
class CodecGrouper5Test {
	
	record TestRecord(int field1, int field2, int field3, int field4, int field5) {}
	...
	void constructorWithValidCodecs() {
		...
		CodecGrouper5<Integer, Integer, Integer, Integer, Integer, TestRecord> grouper = new CodecGrouper5<>(codec1, codec2, codec3, codec4, codec5);
	...
	void constructorWithNullCodecsThrowsException() {
		...
		assertThrows(NullPointerException.class, () -> new CodecGrouper5<>(null, codec, codec, codec, codec));
		assertThrows(NullPointerException.class, () -> new CodecGrouper5<>(codec, null, codec, codec, codec));
		assertThrows(NullPointerException.class, () -> new CodecGrouper5<>(codec, codec, null, codec, codec));
		assertThrows(NullPointerException.class, () -> new CodecGrouper5<>(codec, codec, codec, null, codec));
		assertThrows(NullPointerException.class, () -> new CodecGrouper5<>(codec, codec, codec, codec, null));
	}
	...
	void createWithNullFunctionThrowsException() {
		ConfiguredCodec<Integer, TestRecord> codec = createConfiguredCodec("test", TestRecord::field1);
		CodecGrouper5<Integer, Integer, Integer, Integer, Integer, TestRecord> grouper = new CodecGrouper5<>(codec, codec, codec, codec, codec);
	...
	void equalsWithSameCodecs() {
		...
		ConfiguredCodec<Integer, TestRecord> codec4 = createConfiguredCodec("test4", TestRecord::field4);
		ConfiguredCodec<Integer, TestRecord> codec5 = createConfiguredCodec("test5", TestRecord::field5);
		CodecGrouper5<Integer, Integer, Integer, Integer, Integer, TestRecord> grouper1 = new CodecGrouper5<>(codec1, codec2, codec3, codec4, codec5);
		CodecGrouper5<Integer, Integer, Integer, Integer, Integer, TestRecord> grouper2 = new CodecGrouper5<>(codec1, codec2, codec3, codec4, codec5);
	...
	void equalsWithDifferentCodecs() {
		...
		ConfiguredCodec<Integer, TestRecord> codec3 = createConfiguredCodec("test3", TestRecord::field3);
		ConfiguredCodec<Integer, TestRecord> codec4 = createConfiguredCodec("test4", TestRecord::field4);
		ConfiguredCodec<Integer, TestRecord> codec5a = createConfiguredCodec("test5a", TestRecord::field5);
		ConfiguredCodec<Integer, TestRecord> codec5b = createConfiguredCodec("test5b", TestRecord::field5);
		CodecGrouper5<Integer, Integer, Integer, Integer, Integer, TestRecord> grouper1 = new CodecGrouper5<>(codec1, codec2, codec3, codec4, codec5a);
		CodecGrouper5<Integer, Integer, Integer, Integer, Integer, TestRecord> grouper2 = new CodecGrouper5<>(codec1, codec2, codec3, codec4, codec5b);
