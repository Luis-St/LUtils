...
class MapCodecTest {
	...
	void constructor() {
		...
		assertThrows(NullPointerException.class, () -> new MapCodec<>(null, BOOLEAN, 0, Integer.MAX_VALUE));
		assertThrows(NullPointerException.class, () -> new MapCodec<>(INTEGER, null, 0, Integer.MAX_VALUE));
		assertThrows(IllegalArgumentException.class, () -> new MapCodec<>(INTEGER, BOOLEAN, -1, Integer.MAX_VALUE));
		assertThrows(IllegalArgumentException.class, () -> new MapCodec<>(INTEGER, BOOLEAN, 1, 0));
		assertDoesNotThrow(() -> new MapCodec<>(INTEGER, BOOLEAN));
		assertDoesNotThrow(() -> new MapCodec<>(INTEGER, BOOLEAN, 0, 10));
	}
	...
	void encodeStartSizedExactMatch() {
		JsonTypeProvider typeProvider = JsonTypeProvider.INSTANCE;
		Codec<Map<Integer, Boolean>> codec = new MapCodec<>(INTEGER, BOOLEAN, 2, 2);
		Map<Integer, Boolean> map = Map.of(1, true, 2, false);
	...
	void encodeStartSizedTooSmall() {
		JsonTypeProvider typeProvider = JsonTypeProvider.INSTANCE;
		Codec<Map<Integer, Boolean>> codec = new MapCodec<>(INTEGER, BOOLEAN, 3, 5);
	...
	void encodeStartSizedTooLarge() {
		JsonTypeProvider typeProvider = JsonTypeProvider.INSTANCE;
		Codec<Map<Integer, Boolean>> codec = new MapCodec<>(INTEGER, BOOLEAN, 1, 2);
	...
	void equalsAndHashCode() {
		MapCodec<Integer, Boolean> codec1 = new MapCodec<>(INTEGER, BOOLEAN, 0, 10);
		MapCodec<Integer, Boolean> codec2 = new MapCodec<>(INTEGER, BOOLEAN, 0, 10);
