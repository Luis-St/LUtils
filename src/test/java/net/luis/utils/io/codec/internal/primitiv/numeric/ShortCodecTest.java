...
class ShortCodecTest {
	...
	void encodeStartNullChecks() {
		...
		KeyableCodec<Short> codec = new ShortCodec();
		Short value = 1000;
	...
	void encodeKeyNullChecks() {
		...
		assertThrows(NullPointerException.class, () -> codec.encodeKey(null, (short) 1000));
	...
	void encodeKeyWithValue() {
		...
		Result<String> result = codec.encodeKey(typeProvider, (short) 1000);
		assertTrue(result.isSuccess());
	...
	void decodeStartNullChecks() {
		...
		assertThrows(NullPointerException.class, () -> codec.decodeStart(null, new JsonPrimitive((short) 1000)));
	}
	...
	void decodeStartWithValidValue() {
		...
		Result<Short> result = codec.decodeStart(typeProvider, new JsonPrimitive((short) 1000));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithMaxValue() {
		...
		Result<Short> result = codec.decodeStart(typeProvider, new JsonPrimitive(Short.MAX_VALUE));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithMinValue() {
		...
		Result<Short> result = codec.decodeStart(typeProvider, new JsonPrimitive(Short.MIN_VALUE));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithNonNumber() {
		...
		Result<Short> result = codec.decodeStart(typeProvider, new JsonPrimitive("not a number"));
		assertTrue(result.isError());
	}
	...
	void decodeKeyNullChecks() {
		...
		assertThrows(NullPointerException.class, () -> codec.decodeKey(null, "1000"));
	...
	void decodeKeyWithValidValue() {
		...
		Result<Short> result = codec.decodeKey(typeProvider, "1000");
		assertTrue(result.isSuccess());
		assertEquals((short) 1000, result.resultOrThrow());
	}
	...
	void decodeKeyWithInvalidValue() {
		...
		Result<Short> result = codec.decodeKey(typeProvider, "invalid");
		assertTrue(result.isError());
	...
	void decodeKeyWithOutOfRangeValue() {
		...
		Result<Short> result = codec.decodeKey(typeProvider, "99999");
		assertTrue(result.isError());
