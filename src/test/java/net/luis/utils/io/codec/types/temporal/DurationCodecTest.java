...
class DurationCodecTest {
	...
	void decodeStartNullChecks() {
		...
		assertThrows(NullPointerException.class, () -> codec.decodeStart(null, typeProvider.empty(), new JsonPrimitive("5s")));
	}
	...
	void decodeStartWithNull() {
		...
		Result<Duration> result = codec.decodeStart(typeProvider, typeProvider.empty(), null);
		assertTrue(result.isError());
	...
	void decodeStartWithZero() {
		...
		Result<Duration> result = codec.decodeStart(typeProvider, typeProvider.empty(), new JsonPrimitive("0s"));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithSeconds() {
		...
		Result<Duration> result = codec.decodeStart(typeProvider, typeProvider.empty(), new JsonPrimitive("5s"));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithComplexDuration() {
		...
		Result<Duration> result = codec.decodeStart(typeProvider, typeProvider.empty(), new JsonPrimitive("1d 2h 30m"));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithMilliseconds() {
		...
		Result<Duration> result = codec.decodeStart(typeProvider, typeProvider.empty(), new JsonPrimitive("500ms"));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithNanoseconds() {
		...
		Result<Duration> result = codec.decodeStart(typeProvider, typeProvider.empty(), new JsonPrimitive("123ns"));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithAllUnits() {
		...
		Result<Duration> result = codec.decodeStart(typeProvider, typeProvider.empty(), new JsonPrimitive("1y 2mo 3w 4d 5h 6m 7s 800ms 900ns"));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithInvalidFormat() {
		...
		Result<Duration> result = codec.decodeStart(typeProvider, typeProvider.empty(), new JsonPrimitive("invalid-duration"));
		assertTrue(result.isError());
	...
	void decodeStartWithInvalidUnit() {
		...
		Result<Duration> result = codec.decodeStart(typeProvider, typeProvider.empty(), new JsonPrimitive("5x"));
		assertTrue(result.isError());
	...
	void decodeStartWithNonString() {
		...
		Result<Duration> result = codec.decodeStart(typeProvider, typeProvider.empty(), new JsonPrimitive(42));
		assertTrue(result.isError());
	}
