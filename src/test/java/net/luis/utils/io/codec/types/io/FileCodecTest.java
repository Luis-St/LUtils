...
class FileCodecTest {
	...
	void decodeStartWithNull() {
		...
		Result<File> result = codec.decodeStart(typeProvider, typeProvider.empty(), null);
		assertTrue(result.isError());
	...
	void decodeStartWithValidString() {
		...
		Result<File> result = codec.decodeStart(typeProvider, typeProvider.empty(), new JsonPrimitive("/tmp/test"));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithRelativePath() {
		...
		Result<File> result = codec.decodeStart(typeProvider, typeProvider.empty(), new JsonPrimitive("relative/path"));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithCurrentDirectory() {
		...
		Result<File> result = codec.decodeStart(typeProvider, typeProvider.empty(), new JsonPrimitive("."));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithNonString() {
		...
		Result<File> result = codec.decodeStart(typeProvider, typeProvider.empty(), new JsonPrimitive(42));
		assertTrue(result.isError());
	}
