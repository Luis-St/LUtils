...
class CodecGroupingFunction14Test {
	...
	void createWithNumbers() {
		CodecGroupingFunction14<Double, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double> function = (a, b, c, d, e, f, g, h, i, j, k, l, m, n) -> {
