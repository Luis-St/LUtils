...
class CodecBuilderFunction3Test {
	
	@Test
	void createWithThreeInputs() {
		CodecBuilderFunction3<String, Integer, Boolean, String> function = (str, num, bool) -> str + ":" + num + ":" + bool;
	...
	void createWithMixedTypes() {
		CodecBuilderFunction3<Integer, Integer, Integer, Double> function = (a, b, c) -> (a + b + c) / 3.0;
	...
	void createConditionalLogic() {
		CodecBuilderFunction3<String, String, String, String> function = (first, second, third) -> {
