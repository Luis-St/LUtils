...
class LongCodecTest {
	...
	void encodeStartNullChecks() {
		...
		KeyableCodec<Long> codec = new LongCodec();
	...
	void encodeKeyNullChecks() {
		...
		assertThrows(NullPointerException.class, () -> codec.encodeKey(null, 9999999999L));
	...
	void encodeKeyWithValue() {
		...
		Result<String> result = codec.encodeKey(typeProvider, 9999999999L);
		assertTrue(result.isSuccess());
	...
	void decodeStartNullChecks() {
		...
		assertThrows(NullPointerException.class, () -> codec.decodeStart(null, new JsonPrimitive(9999999999L)));
	}
	...
	void decodeStartWithValidValue() {
		...
		Result<Long> result = codec.decodeStart(typeProvider, new JsonPrimitive(9999999999L));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithMaxValue() {
		...
		Result<Long> result = codec.decodeStart(typeProvider, new JsonPrimitive(Long.MAX_VALUE));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithMinValue() {
		...
		Result<Long> result = codec.decodeStart(typeProvider, new JsonPrimitive(Long.MIN_VALUE));
		assertTrue(result.isSuccess());
	...
	void decodeStartWithNonNumber() {
		...
		Result<Long> result = codec.decodeStart(typeProvider, new JsonPrimitive("not a number"));
		assertTrue(result.isError());
	}
	...
	void decodeKeyNullChecks() {
		...
		assertThrows(NullPointerException.class, () -> codec.decodeKey(null, "9999999999"));
	...
	void decodeKeyWithValidValue() {
		...
		Result<Long> result = codec.decodeKey(typeProvider, "9999999999");
		assertTrue(result.isSuccess());
		assertEquals(9999999999L, result.resultOrThrow());
	}
	...
	void decodeKeyWithInvalidValue() {
		...
		Result<Long> result = codec.decodeKey(typeProvider, "invalid");
		assertTrue(result.isError());
	...
	void decodeKeyWithOutOfRangeValue() {
		...
		Result<Long> result = codec.decodeKey(typeProvider, "99999999999999999999999999999");
		assertTrue(result.isError());
