...
class CodecBuilderFunction13Test {
	
	@Test
	void createWithThirteenInputs() {
		CodecBuilderFunction13<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> function = (a, b, c, d, e, f, g, h, i, j, k, l, m) -> {
	...
	void createWithBooleans() {
		CodecBuilderFunction13<Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean> function = (a, b, c, d, e, f, g, h, i, j, k, l, m) -> {
			return a && b && c && d && e && f && g && h && i && j && k && l && m;
		};
