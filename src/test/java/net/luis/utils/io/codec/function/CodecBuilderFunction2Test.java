...
class CodecBuilderFunction2Test {
	
	@Test
	void createWithTwoInputs() {
		CodecBuilderFunction2<String, Integer, String> function = (str, num) -> str + ":" + num;
	...
	void createWithNullInputs() {
		CodecBuilderFunction2<String, String, String> function = (first, second) -> (first == null ? "null" : first) + "-" + (second == null ? "null" : second);
	...
	void createWithMathOperation() {
		CodecBuilderFunction2<Integer, Integer, Integer> function = Integer::sum;
