...
/**
 * Test class for {@link SqlInsertColumns3}.<br>
 *
 * @author Luis-St
 */
class SqlInsertColumns3Test {
	...
	void constructWithValidBuilderAndColumns() {
		...
		SqlInsertColumns3<Object, Integer, Integer, Integer> wrapper = new SqlInsertColumns3<>(emptyBuilder(table), column1, column2, column3);
	...
	void constructWithNullBuilder() {
		...
		SqlColumn<Object, Integer> column2 = table.column("col2", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column3 = table.column("col3", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns3<>(null, column1, column2, column3));
	}
	...
	void constructWithNullColumn1() {
		...
		SqlColumn<Object, Integer> column2 = table.column("col2", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column3 = table.column("col3", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns3<>(emptyBuilder(table), null, column2, column3));
	}
	...
	void constructWithNullColumn2() {
		...
		SqlColumn<Object, Integer> column2 = table.column("col2", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column3 = table.column("col3", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns3<>(emptyBuilder(table), column1, null, column3));
	}
	...
	void constructWithNullColumn3() {
		...
		SqlColumn<Object, Integer> column2 = table.column("col2", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column3 = table.column("col3", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns3<>(emptyBuilder(table), column1, column2, null));
	}
	...
	void rowWithNullValue1Throws() {
		...
		SqlColumn<Object, Integer> column3 = table.column("col3", INTEGER_TYPE, o -> 0);
		SqlInsertColumns3<Object, Integer, Integer, Integer> wrapper = new SqlInsertColumns3<>(emptyBuilder(table), column1, column2, column3);
		assertThrows(NullPointerException.class, () -> wrapper.row(null, 1, 1));
	}
	...
	void rowWithNullValue2Throws() {
		...
		SqlColumn<Object, Integer> column3 = table.column("col3", INTEGER_TYPE, o -> 0);
		SqlInsertColumns3<Object, Integer, Integer, Integer> wrapper = new SqlInsertColumns3<>(emptyBuilder(table), column1, column2, column3);
		assertThrows(NullPointerException.class, () -> wrapper.row(1, null, 1));
	}
	...
	void rowWithNullValue3Throws() {
		...
		SqlColumn<Object, Integer> column3 = table.column("col3", INTEGER_TYPE, o -> 0);
		SqlInsertColumns3<Object, Integer, Integer, Integer> wrapper = new SqlInsertColumns3<>(emptyBuilder(table), column1, column2, column3);
		assertThrows(NullPointerException.class, () -> wrapper.row(1, 1, null));
	}
	...
	void rowOnPrebuiltMismatchedBuilderThrows() throws SqlException {
		...
		SqlInsertColumns3<Object, Integer, Integer, Integer> wrapper = new SqlInsertColumns3<>(prebuilt, column1, column2, column3);
		assertThrows(SqlStatementBuilderException.class, () -> wrapper.row(1, 1, 1));
	}
	...
	void withAuditUserReturnsNewInstanceWithProvider() {
		...
		SqlInsertColumns3<Object, Integer, Integer, Integer> withProvider = wrapper.withAuditUser(provider);
	...
	void rowAppendsRowAndReturnsNewInstance() throws SqlException {
		...
		SqlColumn<Object, Integer> column3 = table.column("col3", INTEGER_TYPE, o -> 0);
		SqlInsertColumns3<Object, Integer, Integer, Integer> wrapper = new SqlInsertColumns3<>(emptyBuilder(table), column1, column2, column3);
		SqlInsertColumns3<Object, Integer, Integer, Integer> withRow = wrapper.row(1, 1, 1);
	...
	void executeDelegatesToBuilder() throws SqlException {
		...
		SqlInsertColumns3<Object, Integer, Integer, Integer> wrapper = new SqlInsertColumns3<>(builder, column1, column2, column3).row(1, 1, 1);
	...
	void rowCalledMultipleTimesAccumulatesRowsImmutably() throws SqlException {
		...
		RecordingDataSource source = recordingDataSource().rowsAffected(1);
		SqlInsertColumnsBuilder<Object> builder = new SqlInsertColumnsBuilder<>(table, DIALECT, SqlConnectionSource.pooled(source), TIMEOUT, resultSet -> null, null, List.of());
		SqlInsertColumns3<Object, Integer, Integer, Integer> w0 = new SqlInsertColumns3<>(builder, column1, column2, column3);
		SqlInsertColumns3<Object, Integer, Integer, Integer> w1 = w0.row(1, 1, 1);
		SqlInsertColumns3<Object, Integer, Integer, Integer> w2 = w1.row(2, 2, 2);
		...
		assertEquals(3, executed.get(0).chars().filter(c -> c == '?').count());
		assertEquals(6, executed.get(1).chars().filter(c -> c == '?').count());
	}
	...
	void withAuditUserThenRowPreservesAuditUserAcrossRowAppend() throws SqlException {
		...
		new SqlInsertColumns3<>(withProviderBuilder, column1, column2, column3).withAuditUser(provider).row(1, 1, 1).execute();
