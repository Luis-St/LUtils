...
/**
 * Test class for {@link SqlInsertColumns6}.<br>
 *
 * @author Luis-St
 */
class SqlInsertColumns6Test {
	...
	void constructWithValidBuilderAndColumns() {
		...
		SqlInsertColumns6<Object, Integer, Integer, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns6<>(emptyBuilder(table), column1, column2, column3, column4, column5, column6);
	...
	void constructWithNullBuilder() {
		...
		SqlColumn<Object, Integer> column5 = table.column("col5", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column6 = table.column("col6", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns6<>(null, column1, column2, column3, column4, column5, column6));
	}
	...
	void constructWithNullColumn1() {
		...
		SqlColumn<Object, Integer> column5 = table.column("col5", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column6 = table.column("col6", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns6<>(emptyBuilder(table), null, column2, column3, column4, column5, column6));
	}
	...
	void constructWithNullColumn2() {
		...
		SqlColumn<Object, Integer> column5 = table.column("col5", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column6 = table.column("col6", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns6<>(emptyBuilder(table), column1, null, column3, column4, column5, column6));
	}
	...
	void constructWithNullColumn3() {
		...
		SqlColumn<Object, Integer> column5 = table.column("col5", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column6 = table.column("col6", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns6<>(emptyBuilder(table), column1, column2, null, column4, column5, column6));
	}
	...
	void constructWithNullColumn4() {
		...
		SqlColumn<Object, Integer> column5 = table.column("col5", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column6 = table.column("col6", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns6<>(emptyBuilder(table), column1, column2, column3, null, column5, column6));
	}
	...
	void constructWithNullColumn5() {
		...
		SqlColumn<Object, Integer> column5 = table.column("col5", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column6 = table.column("col6", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns6<>(emptyBuilder(table), column1, column2, column3, column4, null, column6));
	}
	...
	void constructWithNullColumn6() {
		...
		SqlColumn<Object, Integer> column5 = table.column("col5", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column6 = table.column("col6", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns6<>(emptyBuilder(table), column1, column2, column3, column4, column5, null));
	}
	...
	void rowWithNullValue1Throws() {
		...
		SqlColumn<Object, Integer> column6 = table.column("col6", INTEGER_TYPE, o -> 0);
		SqlInsertColumns6<Object, Integer, Integer, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns6<>(emptyBuilder(table), column1, column2, column3, column4, column5, column6);
		assertThrows(NullPointerException.class, () -> wrapper.row(null, 1, 1, 1, 1, 1));
	}
	...
	void rowWithNullValue2Throws() {
		...
		SqlColumn<Object, Integer> column6 = table.column("col6", INTEGER_TYPE, o -> 0);
		SqlInsertColumns6<Object, Integer, Integer, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns6<>(emptyBuilder(table), column1, column2, column3, column4, column5, column6);
		assertThrows(NullPointerException.class, () -> wrapper.row(1, null, 1, 1, 1, 1));
	}
	...
	void rowWithNullValue3Throws() {
		...
		SqlColumn<Object, Integer> column6 = table.column("col6", INTEGER_TYPE, o -> 0);
		SqlInsertColumns6<Object, Integer, Integer, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns6<>(emptyBuilder(table), column1, column2, column3, column4, column5, column6);
		assertThrows(NullPointerException.class, () -> wrapper.row(1, 1, null, 1, 1, 1));
	}
	...
	void rowWithNullValue4Throws() {
		...
		SqlColumn<Object, Integer> column6 = table.column("col6", INTEGER_TYPE, o -> 0);
		SqlInsertColumns6<Object, Integer, Integer, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns6<>(emptyBuilder(table), column1, column2, column3, column4, column5, column6);
		assertThrows(NullPointerException.class, () -> wrapper.row(1, 1, 1, null, 1, 1));
	}
	...
	void rowWithNullValue5Throws() {
		...
		SqlColumn<Object, Integer> column6 = table.column("col6", INTEGER_TYPE, o -> 0);
		SqlInsertColumns6<Object, Integer, Integer, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns6<>(emptyBuilder(table), column1, column2, column3, column4, column5, column6);
		assertThrows(NullPointerException.class, () -> wrapper.row(1, 1, 1, 1, null, 1));
	}
	...
	void rowWithNullValue6Throws() {
		...
		SqlColumn<Object, Integer> column6 = table.column("col6", INTEGER_TYPE, o -> 0);
		SqlInsertColumns6<Object, Integer, Integer, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns6<>(emptyBuilder(table), column1, column2, column3, column4, column5, column6);
		assertThrows(NullPointerException.class, () -> wrapper.row(1, 1, 1, 1, 1, null));
	}
	...
	void rowOnPrebuiltMismatchedBuilderThrows() throws SqlException {
		...
		SqlInsertColumns6<Object, Integer, Integer, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns6<>(prebuilt, column1, column2, column3, column4, column5, column6);
		assertThrows(SqlStatementBuilderException.class, () -> wrapper.row(1, 1, 1, 1, 1, 1));
	}
	...
	void withAuditUserReturnsNewInstanceWithProvider() {
		...
		SqlInsertColumns6<Object, Integer, Integer, Integer, Integer, Integer, Integer> withProvider = wrapper.withAuditUser(provider);
	...
	void rowAppendsRowAndReturnsNewInstance() throws SqlException {
		...
		SqlColumn<Object, Integer> column6 = table.column("col6", INTEGER_TYPE, o -> 0);
		SqlInsertColumns6<Object, Integer, Integer, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns6<>(emptyBuilder(table), column1, column2, column3, column4, column5, column6);
		SqlInsertColumns6<Object, Integer, Integer, Integer, Integer, Integer, Integer> withRow = wrapper.row(1, 1, 1, 1, 1, 1);
	...
	void executeDelegatesToBuilder() throws SqlException {
		...
		SqlInsertColumns6<Object, Integer, Integer, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns6<>(builder, column1, column2, column3, column4, column5, column6).row(1, 1, 1, 1, 1, 1);
	...
	void rowCalledMultipleTimesAccumulatesRowsImmutably() throws SqlException {
		...
		RecordingDataSource source = recordingDataSource().rowsAffected(1);
		SqlInsertColumnsBuilder<Object> builder = new SqlInsertColumnsBuilder<>(table, DIALECT, SqlConnectionSource.pooled(source), TIMEOUT, resultSet -> null, null, List.of());
		SqlInsertColumns6<Object, Integer, Integer, Integer, Integer, Integer, Integer> w0 = new SqlInsertColumns6<>(builder, column1, column2, column3, column4, column5, column6);
		SqlInsertColumns6<Object, Integer, Integer, Integer, Integer, Integer, Integer> w1 = w0.row(1, 1, 1, 1, 1, 1);
		SqlInsertColumns6<Object, Integer, Integer, Integer, Integer, Integer, Integer> w2 = w1.row(2, 2, 2, 2, 2, 2);
		...
		assertEquals(6, executed.get(0).chars().filter(c -> c == '?').count());
		assertEquals(12, executed.get(1).chars().filter(c -> c == '?').count());
	}
	...
	void withAuditUserThenRowPreservesAuditUserAcrossRowAppend() throws SqlException {
		...
		new SqlInsertColumns6<>(withProviderBuilder, column1, column2, column3, column4, column5, column6).withAuditUser(provider).row(1, 1, 1, 1, 1, 1).execute();
		...
		new SqlInsertColumns6<>(withoutProviderBuilder, column1, column2, column3, column4, column5, column6).row(1, 1, 1, 1, 1, 1).execute();
