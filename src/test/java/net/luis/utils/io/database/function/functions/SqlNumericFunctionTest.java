...
/**
 * Test class for {@link SqlNumericFunction}.<br>
 *
 * @author Luis-St
 */
class SqlNumericFunctionTest {
	
	@Test
	void toSqlWithNullDialect() {
		SqlNumericFunction<Integer> function = () -> SqlTestFixtures.INTEGER_TYPE;
	...
	@Test
	void toSqlRendersConcreteNumericFunctionWithDefaultDialect() throws SqlException {
