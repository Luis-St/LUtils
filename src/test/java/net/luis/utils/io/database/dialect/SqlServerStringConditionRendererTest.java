...
/**
 * Test class for {@link SqlServerStringConditionRenderer}.<br>
 *
 * @author Luis-St
 */
class SqlServerStringConditionRendererTest {
	
	private static final SqlServerStringConditionRenderer RENDERER = new SqlServerStringConditionRenderer(SqlDialects.SQL_SERVER);
	...
	@Test
	void renderConcatExpressionUsesPlusOperator() throws SqlException {
		assertTrue(RENDERER.renderConcatExpression(SqlRenderer.empty(), SqlRendered.of("a"), SqlRendered.of("b")).sql().contains("+"));
	}
}
