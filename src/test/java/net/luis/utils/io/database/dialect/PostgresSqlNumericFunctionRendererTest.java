...
/**
 * Test class for {@link PostgresSqlNumericFunctionRenderer}.<br>
 *
 * @author Luis-St
 */
class PostgresSqlNumericFunctionRendererTest {
	
	private static final PostgresSqlNumericFunctionRenderer RENDERER = new PostgresSqlNumericFunctionRenderer(SqlDialects.POSTGRESQL);
	...
	@Test
	void renderTruncateProducesTruncWithZeroScale() throws SqlException {
