...
/**
 * Test class for {@link SqlInsertColumns7}.<br>
 *
 * @author Luis-St
 */
class SqlInsertColumns7Test {
	...
	void constructWithValidBuilderAndColumns() {
		...
		SqlInsertColumns7<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns7<>(emptyBuilder(table), column1, column2, column3, column4, column5, column6, column7);
	...
	void constructWithNullBuilder() {
		...
		SqlColumn<Object, Integer> column6 = table.column("col6", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column7 = table.column("col7", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns7<>(null, column1, column2, column3, column4, column5, column6, column7));
	}
	...
	void constructWithNullColumn1() {
		...
		SqlColumn<Object, Integer> column6 = table.column("col6", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column7 = table.column("col7", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns7<>(emptyBuilder(table), null, column2, column3, column4, column5, column6, column7));
	}
	...
	void constructWithNullColumn2() {
		...
		SqlColumn<Object, Integer> column6 = table.column("col6", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column7 = table.column("col7", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns7<>(emptyBuilder(table), column1, null, column3, column4, column5, column6, column7));
	}
	...
	void constructWithNullColumn3() {
		...
		SqlColumn<Object, Integer> column6 = table.column("col6", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column7 = table.column("col7", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns7<>(emptyBuilder(table), column1, column2, null, column4, column5, column6, column7));
	}
	...
	void constructWithNullColumn4() {
		...
		SqlColumn<Object, Integer> column6 = table.column("col6", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column7 = table.column("col7", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns7<>(emptyBuilder(table), column1, column2, column3, null, column5, column6, column7));
	}
	...
	void constructWithNullColumn5() {
		...
		SqlColumn<Object, Integer> column6 = table.column("col6", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column7 = table.column("col7", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns7<>(emptyBuilder(table), column1, column2, column3, column4, null, column6, column7));
	}
	...
	void constructWithNullColumn6() {
		...
		SqlColumn<Object, Integer> column6 = table.column("col6", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column7 = table.column("col7", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns7<>(emptyBuilder(table), column1, column2, column3, column4, column5, null, column7));
	}
	...
	void constructWithNullColumn7() {
		...
		SqlColumn<Object, Integer> column6 = table.column("col6", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column7 = table.column("col7", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns7<>(emptyBuilder(table), column1, column2, column3, column4, column5, column6, null));
	}
	...
	void rowWithNullValue1Throws() {
		...
		SqlColumn<Object, Integer> column7 = table.column("col7", INTEGER_TYPE, o -> 0);
		SqlInsertColumns7<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns7<>(emptyBuilder(table), column1, column2, column3, column4, column5, column6, column7);
		assertThrows(NullPointerException.class, () -> wrapper.row(null, 1, 1, 1, 1, 1, 1));
	}
	...
	void rowWithNullValue2Throws() {
		...
		SqlColumn<Object, Integer> column7 = table.column("col7", INTEGER_TYPE, o -> 0);
		SqlInsertColumns7<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns7<>(emptyBuilder(table), column1, column2, column3, column4, column5, column6, column7);
		assertThrows(NullPointerException.class, () -> wrapper.row(1, null, 1, 1, 1, 1, 1));
	}
	...
	void rowWithNullValue3Throws() {
		...
		SqlColumn<Object, Integer> column7 = table.column("col7", INTEGER_TYPE, o -> 0);
		SqlInsertColumns7<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns7<>(emptyBuilder(table), column1, column2, column3, column4, column5, column6, column7);
		assertThrows(NullPointerException.class, () -> wrapper.row(1, 1, null, 1, 1, 1, 1));
	}
	...
	void rowWithNullValue4Throws() {
		...
		SqlColumn<Object, Integer> column7 = table.column("col7", INTEGER_TYPE, o -> 0);
		SqlInsertColumns7<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns7<>(emptyBuilder(table), column1, column2, column3, column4, column5, column6, column7);
		assertThrows(NullPointerException.class, () -> wrapper.row(1, 1, 1, null, 1, 1, 1));
	}
	...
	void rowWithNullValue5Throws() {
		...
		SqlColumn<Object, Integer> column7 = table.column("col7", INTEGER_TYPE, o -> 0);
		SqlInsertColumns7<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns7<>(emptyBuilder(table), column1, column2, column3, column4, column5, column6, column7);
		assertThrows(NullPointerException.class, () -> wrapper.row(1, 1, 1, 1, null, 1, 1));
	}
	...
	void rowWithNullValue6Throws() {
		...
		SqlColumn<Object, Integer> column7 = table.column("col7", INTEGER_TYPE, o -> 0);
		SqlInsertColumns7<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns7<>(emptyBuilder(table), column1, column2, column3, column4, column5, column6, column7);
		assertThrows(NullPointerException.class, () -> wrapper.row(1, 1, 1, 1, 1, null, 1));
	}
	...
	void rowWithNullValue7Throws() {
		...
		SqlColumn<Object, Integer> column7 = table.column("col7", INTEGER_TYPE, o -> 0);
		SqlInsertColumns7<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns7<>(emptyBuilder(table), column1, column2, column3, column4, column5, column6, column7);
		assertThrows(NullPointerException.class, () -> wrapper.row(1, 1, 1, 1, 1, 1, null));
	}
	...
	void rowOnPrebuiltMismatchedBuilderThrows() throws SqlException {
		...
		SqlInsertColumns7<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns7<>(prebuilt, column1, column2, column3, column4, column5, column6, column7);
		assertThrows(SqlStatementBuilderException.class, () -> wrapper.row(1, 1, 1, 1, 1, 1, 1));
	}
	...
	void withAuditUserReturnsNewInstanceWithProvider() {
		...
		SqlInsertColumns7<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> withProvider = wrapper.withAuditUser(provider);
	...
	void rowAppendsRowAndReturnsNewInstance() throws SqlException {
		...
		SqlColumn<Object, Integer> column7 = table.column("col7", INTEGER_TYPE, o -> 0);
		SqlInsertColumns7<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns7<>(emptyBuilder(table), column1, column2, column3, column4, column5, column6, column7);
		SqlInsertColumns7<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> withRow = wrapper.row(1, 1, 1, 1, 1, 1, 1);
	...
	void executeDelegatesToBuilder() throws SqlException {
		...
		SqlInsertColumns7<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns7<>(builder, column1, column2, column3, column4, column5, column6, column7).row(1, 1, 1, 1, 1, 1, 1);
	...
	void rowCalledMultipleTimesAccumulatesRowsImmutably() throws SqlException {
		...
		RecordingDataSource source = recordingDataSource().rowsAffected(1);
		SqlInsertColumnsBuilder<Object> builder = new SqlInsertColumnsBuilder<>(table, DIALECT, SqlConnectionSource.pooled(source), TIMEOUT, resultSet -> null, null, List.of());
		SqlInsertColumns7<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> w0 = new SqlInsertColumns7<>(builder, column1, column2, column3, column4, column5, column6, column7);
		SqlInsertColumns7<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> w1 = w0.row(1, 1, 1, 1, 1, 1, 1);
		SqlInsertColumns7<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> w2 = w1.row(2, 2, 2, 2, 2, 2, 2);
		...
		assertEquals(7, executed.get(0).chars().filter(c -> c == '?').count());
		assertEquals(14, executed.get(1).chars().filter(c -> c == '?').count());
	}
	...
	void withAuditUserThenRowPreservesAuditUserAcrossRowAppend() throws SqlException {
		...
		new SqlInsertColumns7<>(withProviderBuilder, column1, column2, column3, column4, column5, column6, column7).withAuditUser(provider).row(1, 1, 1, 1, 1, 1, 1).execute();
		...
		new SqlInsertColumns7<>(withoutProviderBuilder, column1, column2, column3, column4, column5, column6, column7).row(1, 1, 1, 1, 1, 1, 1).execute();
