...
/**
 * Test class for {@link SqlServerTableRenderer}.<br>
 *
 * @author Luis-St
 */
class SqlServerTableRendererTest {
	
	private static final SqlServerTableRenderer RENDERER = new SqlServerTableRenderer(SqlDialects.SQL_SERVER);
	...
	@Test
	void renderAutoIncrementProducesIdentity() throws SqlException {
