...
/**
 * Test class for {@link SqlInsertColumns4}.<br>
 *
 * @author Luis-St
 */
class SqlInsertColumns4Test {
	...
	void constructWithValidBuilderAndColumns() {
		...
		SqlInsertColumns4<Object, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns4<>(emptyBuilder(table), column1, column2, column3, column4);
	...
	void constructWithNullBuilder() {
		...
		SqlColumn<Object, Integer> column3 = table.column("col3", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column4 = table.column("col4", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns4<>(null, column1, column2, column3, column4));
	}
	...
	void constructWithNullColumn1() {
		...
		SqlColumn<Object, Integer> column3 = table.column("col3", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column4 = table.column("col4", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns4<>(emptyBuilder(table), null, column2, column3, column4));
	}
	...
	void constructWithNullColumn2() {
		...
		SqlColumn<Object, Integer> column3 = table.column("col3", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column4 = table.column("col4", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns4<>(emptyBuilder(table), column1, null, column3, column4));
	}
	...
	void constructWithNullColumn3() {
		...
		SqlColumn<Object, Integer> column3 = table.column("col3", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column4 = table.column("col4", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns4<>(emptyBuilder(table), column1, column2, null, column4));
	}
	...
	void constructWithNullColumn4() {
		...
		SqlColumn<Object, Integer> column3 = table.column("col3", INTEGER_TYPE, o -> 0);
		SqlColumn<Object, Integer> column4 = table.column("col4", INTEGER_TYPE, o -> 0);
		assertThrows(NullPointerException.class, () -> new SqlInsertColumns4<>(emptyBuilder(table), column1, column2, column3, null));
	}
	...
	void rowWithNullValue1Throws() {
		...
		SqlColumn<Object, Integer> column4 = table.column("col4", INTEGER_TYPE, o -> 0);
		SqlInsertColumns4<Object, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns4<>(emptyBuilder(table), column1, column2, column3, column4);
		assertThrows(NullPointerException.class, () -> wrapper.row(null, 1, 1, 1));
	}
	...
	void rowWithNullValue2Throws() {
		...
		SqlColumn<Object, Integer> column4 = table.column("col4", INTEGER_TYPE, o -> 0);
		SqlInsertColumns4<Object, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns4<>(emptyBuilder(table), column1, column2, column3, column4);
		assertThrows(NullPointerException.class, () -> wrapper.row(1, null, 1, 1));
	}
	...
	void rowWithNullValue3Throws() {
		...
		SqlColumn<Object, Integer> column4 = table.column("col4", INTEGER_TYPE, o -> 0);
		SqlInsertColumns4<Object, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns4<>(emptyBuilder(table), column1, column2, column3, column4);
		assertThrows(NullPointerException.class, () -> wrapper.row(1, 1, null, 1));
	}
	...
	void rowWithNullValue4Throws() {
		...
		SqlColumn<Object, Integer> column4 = table.column("col4", INTEGER_TYPE, o -> 0);
		SqlInsertColumns4<Object, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns4<>(emptyBuilder(table), column1, column2, column3, column4);
		assertThrows(NullPointerException.class, () -> wrapper.row(1, 1, 1, null));
	}
	...
	void rowOnPrebuiltMismatchedBuilderThrows() throws SqlException {
		...
		SqlInsertColumns4<Object, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns4<>(prebuilt, column1, column2, column3, column4);
		assertThrows(SqlStatementBuilderException.class, () -> wrapper.row(1, 1, 1, 1));
	}
	...
	void withAuditUserReturnsNewInstanceWithProvider() {
		...
		SqlInsertColumns4<Object, Integer, Integer, Integer, Integer> withProvider = wrapper.withAuditUser(provider);
	...
	void rowAppendsRowAndReturnsNewInstance() throws SqlException {
		...
		SqlColumn<Object, Integer> column4 = table.column("col4", INTEGER_TYPE, o -> 0);
		SqlInsertColumns4<Object, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns4<>(emptyBuilder(table), column1, column2, column3, column4);
		SqlInsertColumns4<Object, Integer, Integer, Integer, Integer> withRow = wrapper.row(1, 1, 1, 1);
	...
	void executeDelegatesToBuilder() throws SqlException {
		...
		SqlInsertColumns4<Object, Integer, Integer, Integer, Integer> wrapper = new SqlInsertColumns4<>(builder, column1, column2, column3, column4).row(1, 1, 1, 1);
	...
	void rowCalledMultipleTimesAccumulatesRowsImmutably() throws SqlException {
		...
		RecordingDataSource source = recordingDataSource().rowsAffected(1);
		SqlInsertColumnsBuilder<Object> builder = new SqlInsertColumnsBuilder<>(table, DIALECT, SqlConnectionSource.pooled(source), TIMEOUT, resultSet -> null, null, List.of());
		SqlInsertColumns4<Object, Integer, Integer, Integer, Integer> w0 = new SqlInsertColumns4<>(builder, column1, column2, column3, column4);
		SqlInsertColumns4<Object, Integer, Integer, Integer, Integer> w1 = w0.row(1, 1, 1, 1);
		SqlInsertColumns4<Object, Integer, Integer, Integer, Integer> w2 = w1.row(2, 2, 2, 2);
		...
		assertEquals(4, executed.get(0).chars().filter(c -> c == '?').count());
		assertEquals(8, executed.get(1).chars().filter(c -> c == '?').count());
	}
	...
	void withAuditUserThenRowPreservesAuditUserAcrossRowAppend() throws SqlException {
		...
		new SqlInsertColumns4<>(withProviderBuilder, column1, column2, column3, column4).withAuditUser(provider).row(1, 1, 1, 1).execute();
		...
		new SqlInsertColumns4<>(withoutProviderBuilder, column1, column2, column3, column4).row(1, 1, 1, 1).execute();
