...
/**
 * Test class for {@link SqlEnableAuditingOperation}.<br>
 *
 * @author Luis-St
 */
class SqlEnableAuditingOperationTest {
	...
	void constructWithNullTable() {
		assertThrows(NullPointerException.class, () -> new SqlEnableAuditingOperation(null, SqlAuditConfig.DEFAULT));
	}
	
	@Test
	void constructWithNullConfig() {
		assertThrows(NullPointerException.class, () -> new SqlEnableAuditingOperation(SqlTestFixtures.sampleTable(), null));
	}
}
