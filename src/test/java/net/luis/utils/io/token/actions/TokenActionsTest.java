...
import net.luis.utils.io.token.actions.filters.ExtractTokenAction;
import net.luis.utils.io.token.actions.filters.FilterTokenAction;
import net.luis.utils.io.token.actions.filters.SkipTokenAction;
import net.luis.utils.io.token.actions.transformers.ConvertTokenAction;
import net.luis.utils.io.token.actions.transformers.SplitTokenAction;
import net.luis.utils.io.token.actions.transformers.TransformTokenAction;
import net.luis.utils.io.token.actions.transformers.WrapTokenAction;
...
class TokenActionsTest {
	...
	private static @NotNull Predicate<Token> createTestPredicate() {
		return token -> "test".equals(token.value());
	}
	
	private static @NotNull Consumer<Token> createTestConsumer() {
		return token -> {};
	}
