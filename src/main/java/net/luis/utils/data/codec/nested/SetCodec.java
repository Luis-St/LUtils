...
public class SetCodec<T> implements NestedCodec<Set<T>> {
	
	private final Codec<T> innerCodec;
	
	public SetCodec(@NotNull Codec<T> innerCodec) {
	...
	@Override
	public @NotNull <X> Set<T> decode(@NotNull ParserCache<X> cache) {
		return null;
	}
	
	@Override
	public @NotNull String encode(@NotNull Set<T> set) {
	...
	@Override
	public @NotNull Set<T> getDefaultValue() {
