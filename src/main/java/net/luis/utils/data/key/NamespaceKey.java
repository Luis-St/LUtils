...
public class NamespaceKey implements Key {
	
	private static final Pattern VALIDATOR = Pattern.compile("^(?!.*(?:\\.-|\\.\\.|--))(?![.\\-])[a-z0-9.-]+(?<![.\\-])$");
	
	private final String key;
	
	NamespaceKey(@NotNull String key) {
	...
	@Override
	public @NotNull KeyType<NamespaceKey> getType() {
		return KeyType.NAMESPACE;
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof NamespaceKey namespaceKey)) return false;
		
		return this.key.equals(namespaceKey.key);
	}
