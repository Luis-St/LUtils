...
/**
 * Represents the SQL bitwise {@code AND} function.<br>
 *
 * @author Luis-St
 *
...
public record SqlBitwiseAndFunction<T extends Number>(
	...
	/**
	 * Constructs a new bitwise AND function inferring the sql type from the operand expressions.<br>
	 *
	 * @param firstOperand The first operand expression
	 * @param secondOperand The second operand expression
	...
	/**
	 * Constructs a new bitwise AND function with the given operands and sql type.<br>
