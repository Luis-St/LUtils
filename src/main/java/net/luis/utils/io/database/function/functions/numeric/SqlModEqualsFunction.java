...
public record SqlModEqualsFunction(@NonNull SqlExpression<?> value, @NonNull SqlExpression<?> divisor, @NonNull SqlExpression<?> remainder) implements SqlNumericFunction {}
