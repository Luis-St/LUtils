...
/**
 * A compile-time checked, fourteenth-column insert builder that is not driven by an entity.<br>
 ...
 */
public final class SqlInsertColumns14<E, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> {
	...
	/**
	 * Constructs a new fourteenth-column insert builder.<br>
	 *
	 ...
	 */
	public @NonNull SqlInsertColumns14<E, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> withAuditUser(@Nullable SqlAuditUserProvider auditUserProvider) {
		return new SqlInsertColumns14<>(this.builder.withAuditUser(auditUserProvider), this.column1, this.column2, this.column3, this.column4, this.column5, this.column6, this.column7, this.column8, this.column9, this.column10, this.column11, this.column12, this.column13, this.column14);
	}
	 ...
	 */
	public @NonNull SqlInsertColumns14<E, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> row(@NonNull T1 value1, @NonNull T2 value2, @NonNull T3 value3, @NonNull T4 value4, @NonNull T5 value5, @NonNull T6 value6, @NonNull T7 value7, @NonNull T8 value8, @NonNull T9 value9, @NonNull T10 value10, @NonNull T11 value11, @NonNull T12 value12, @NonNull T13 value13, @NonNull T14 value14) throws SqlStatementBuilderException {
		...
		return new SqlInsertColumns14<>(next, this.column1, this.column2, this.column3, this.column4, this.column5, this.column6, this.column7, this.column8, this.column9, this.column10, this.column11, this.column12, this.column13, this.column14);
	}
