...
public record SqlLagFunction(@NonNull SqlExpression<?> column, @Nullable SqlExpression<?> offset, @Nullable SqlExpression<?> defaultValue) implements SqlWindowFunction {}
