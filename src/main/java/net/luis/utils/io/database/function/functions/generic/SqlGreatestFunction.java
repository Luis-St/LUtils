...
/**
 * Represents the SQL {@code GREATEST} function.<br>
 * It returns the largest value from the given list of expressions.<br>
 *
 * @author Luis-St
 *
...
public record SqlGreatestFunction<T>(@NonNull @Unmodifiable List<SqlExpression<T>> expressions) implements SqlFunction<T> {
	...
	/**
	 * Constructs a new sql greatest function with the given expressions.<br>
