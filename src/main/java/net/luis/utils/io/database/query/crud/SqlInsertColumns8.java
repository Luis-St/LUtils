...
/**
 * A compile-time checked, eighth-column insert builder that is not driven by an entity.<br>
 ...
 */
public final class SqlInsertColumns8<E, T1, T2, T3, T4, T5, T6, T7, T8> {
	...
	/**
	 * Constructs a new eighth-column insert builder.<br>
	 *
	 ...
	 */
	public @NonNull SqlInsertColumns8<E, T1, T2, T3, T4, T5, T6, T7, T8> withAuditUser(@Nullable SqlAuditUserProvider auditUserProvider) {
		return new SqlInsertColumns8<>(this.builder.withAuditUser(auditUserProvider), this.column1, this.column2, this.column3, this.column4, this.column5, this.column6, this.column7, this.column8);
	}
	 ...
	 */
	public @NonNull SqlInsertColumns8<E, T1, T2, T3, T4, T5, T6, T7, T8> row(@NonNull T1 value1, @NonNull T2 value2, @NonNull T3 value3, @NonNull T4 value4, @NonNull T5 value5, @NonNull T6 value6, @NonNull T7 value7, @NonNull T8 value8) throws SqlStatementBuilderException {
		...
		return new SqlInsertColumns8<>(next, this.column1, this.column2, this.column3, this.column4, this.column5, this.column6, this.column7, this.column8);
	}
