...
/**
 * A compile-time checked, five-column insert builder that is not driven by an entity.<br>
 ...
 */
public final class SqlInsertColumns5<E, T1, T2, T3, T4, T5> {
	...
	/**
	 * Constructs a new five-column insert builder.<br>
	 *
	 ...
	 */
	public @NonNull SqlInsertColumns5<E, T1, T2, T3, T4, T5> withAuditUser(@Nullable SqlAuditUserProvider auditUserProvider) {
		return new SqlInsertColumns5<>(this.builder.withAuditUser(auditUserProvider), this.column1, this.column2, this.column3, this.column4, this.column5);
	}
	 ...
	 */
	public @NonNull SqlInsertColumns5<E, T1, T2, T3, T4, T5> row(@NonNull T1 value1, @NonNull T2 value2, @NonNull T3 value3, @NonNull T4 value4, @NonNull T5 value5) throws SqlStatementBuilderException {
		...
		return new SqlInsertColumns5<>(next, this.column1, this.column2, this.column3, this.column4, this.column5);
	}
