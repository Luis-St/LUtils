...
public record SqlLeftPadFunction(@NonNull SqlExpression<?> expression, @NonNull SqlExpression<?> length, @NonNull SqlExpression<?> fill) implements SqlStringFunction {}
