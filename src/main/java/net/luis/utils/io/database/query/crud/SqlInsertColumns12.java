...
/**
 * A compile-time checked, twelfth-column insert builder that is not driven by an entity.<br>
 ...
 */
public final class SqlInsertColumns12<E, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> {
	...
	/**
	 * Constructs a new twelfth-column insert builder.<br>
	 *
	 ...
	 */
	public @NonNull SqlInsertColumns12<E, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> withAuditUser(@Nullable SqlAuditUserProvider auditUserProvider) {
		return new SqlInsertColumns12<>(this.builder.withAuditUser(auditUserProvider), this.column1, this.column2, this.column3, this.column4, this.column5, this.column6, this.column7, this.column8, this.column9, this.column10, this.column11, this.column12);
	}
	 ...
	 */
	public @NonNull SqlInsertColumns12<E, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> row(@NonNull T1 value1, @NonNull T2 value2, @NonNull T3 value3, @NonNull T4 value4, @NonNull T5 value5, @NonNull T6 value6, @NonNull T7 value7, @NonNull T8 value8, @NonNull T9 value9, @NonNull T10 value10, @NonNull T11 value11, @NonNull T12 value12) throws SqlStatementBuilderException {
		...
		return new SqlInsertColumns12<>(next, this.column1, this.column2, this.column3, this.column4, this.column5, this.column6, this.column7, this.column8, this.column9, this.column10, this.column11, this.column12);
	}
