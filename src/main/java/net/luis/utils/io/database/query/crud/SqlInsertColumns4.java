...
/**
 * A compile-time checked, four-column insert builder that is not driven by an entity.<br>
 ...
 */
public final class SqlInsertColumns4<E, T1, T2, T3, T4> {
	...
	/**
	 * Constructs a new four-column insert builder.<br>
	 *
	 ...
	 */
	public @NonNull SqlInsertColumns4<E, T1, T2, T3, T4> withAuditUser(@Nullable SqlAuditUserProvider auditUserProvider) {
		return new SqlInsertColumns4<>(this.builder.withAuditUser(auditUserProvider), this.column1, this.column2, this.column3, this.column4);
	}
	 ...
	 */
	public @NonNull SqlInsertColumns4<E, T1, T2, T3, T4> row(@NonNull T1 value1, @NonNull T2 value2, @NonNull T3 value3, @NonNull T4 value4) throws SqlStatementBuilderException {
		...
		return new SqlInsertColumns4<>(next, this.column1, this.column2, this.column3, this.column4);
	}
