...
import net.luis.utils.io.database.function.SqlTemporalPart;
...
public record SqlExtractFunction(@NonNull SqlTemporalPart part, @NonNull SqlExpression<?> expression) implements SqlTemporalFunction {}
