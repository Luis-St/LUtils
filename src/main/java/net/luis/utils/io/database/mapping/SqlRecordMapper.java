...
public interface SqlRecordMapper<T> {
	...
	/**
	 * Maps an array of column values to a record instance.<br>
	 *
	 * @param columnValues The column values from the result set row
	 * @return The mapped record instance
	 */
	@NonNull T map(Object @NonNull [] columnValues);
