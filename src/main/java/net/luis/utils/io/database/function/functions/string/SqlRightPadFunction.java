...
public record SqlRightPadFunction(@NonNull SqlExpression<?> expression, @NonNull SqlExpression<?> length, @NonNull SqlExpression<?> fill) implements SqlStringFunction {}
