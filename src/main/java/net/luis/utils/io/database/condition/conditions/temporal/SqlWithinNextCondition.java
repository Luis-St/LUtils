...
/**
 * A condition that checks whether a temporal value lies within the next given duration relative to now.<br>
 *
 * @author Luis-St
 *
 * @param value The temporal expression to check
 * @param duration The duration that defines the time window starting at now
 */
public record SqlWithinNextCondition(
	...
	/**
	 * Constructs a new within-next condition with the given value and duration expressions.<br>
