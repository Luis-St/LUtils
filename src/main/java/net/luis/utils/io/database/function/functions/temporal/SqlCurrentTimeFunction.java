...
/**
 * Represents the SQL {@code CURRENT_TIME} function.<br>
 * Returns the current time of the database server.<br>
 *
 * @author Luis-St
 *
...
public record SqlCurrentTimeFunction<T extends Temporal>(@NonNull SqlType<T> type) implements SqlTemporalFunction<T> {
	...
	/**
	 * Constructs a new current time function with the given sql type.<br>
