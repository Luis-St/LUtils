...
/**
 * Represents the SQL {@code ASIN} trigonometric function.<br>
 *
 * @author Luis-St
 *
...
public record SqlAsinFunction(@NonNull SqlExpression<? extends Number> expression) implements SqlNumericFunction<Double> {
	
	/**
	 * Constructs a new arc sine function with the given operand expression.<br>
