...
/**
 * Represents the SQL {@code NOW} function.<br>
...
public record SqlNowFunction<T extends Temporal>(@NonNull SqlType<T> type) implements SqlTemporalFunction<T> {
	
	/**
	 * Constructs a new now function with the given sql type.<br>
