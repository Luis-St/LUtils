...
public class SqlServerMigrationOperationRenderer extends SqlMigrationOperationRenderer {
	
	public SqlServerMigrationOperationRenderer(@NonNull SqlDialect dialect) {
		super(dialect);
	}
