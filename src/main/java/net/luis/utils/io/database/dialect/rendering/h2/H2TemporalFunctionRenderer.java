...
package net.luis.utils.io.database.dialect.rendering.h2;
...
public class H2TemporalFunctionRenderer extends SqlTemporalFunctionRenderer {
	
	public H2TemporalFunctionRenderer(@NonNull SqlDialect dialect) {
		super(dialect);
	}
