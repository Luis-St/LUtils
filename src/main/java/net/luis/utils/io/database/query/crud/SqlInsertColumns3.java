...
/**
 * A compile-time checked, three-column insert builder that is not driven by an entity.<br>
 ...
 */
public final class SqlInsertColumns3<E, T1, T2, T3> {
	...
	/**
	 * Constructs a new three-column insert builder.<br>
	 *
	 ...
	 */
	SqlInsertColumns3(@NonNull SqlInsertColumnsBuilder<E> builder, @NonNull SqlColumn<E, T1> column1, @NonNull SqlColumn<E, T2> column2, @NonNull SqlColumn<E, T3> column3) {
	 ...
	 */
	public @NonNull SqlInsertColumns3<E, T1, T2, T3> withAuditUser(@Nullable SqlAuditUserProvider auditUserProvider) {
		return new SqlInsertColumns3<>(this.builder.withAuditUser(auditUserProvider), this.column1, this.column2, this.column3);
	}
	 ...
	 */
	public @NonNull SqlInsertColumns3<E, T1, T2, T3> row(@NonNull T1 value1, @NonNull T2 value2, @NonNull T3 value3) throws SqlStatementBuilderException {
		...
		return new SqlInsertColumns3<>(next, this.column1, this.column2, this.column3);
	}
