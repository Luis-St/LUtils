...
/**
 * A compile-time checked, six-column insert builder that is not driven by an entity.<br>
 ...
 */
public final class SqlInsertColumns6<E, T1, T2, T3, T4, T5, T6> {
	...
	/**
	 * Constructs a new six-column insert builder.<br>
	 *
	 ...
	 */
	public @NonNull SqlInsertColumns6<E, T1, T2, T3, T4, T5, T6> withAuditUser(@Nullable SqlAuditUserProvider auditUserProvider) {
		return new SqlInsertColumns6<>(this.builder.withAuditUser(auditUserProvider), this.column1, this.column2, this.column3, this.column4, this.column5, this.column6);
	}
	 ...
	 */
	public @NonNull SqlInsertColumns6<E, T1, T2, T3, T4, T5, T6> row(@NonNull T1 value1, @NonNull T2 value2, @NonNull T3 value3, @NonNull T4 value4, @NonNull T5 value5, @NonNull T6 value6) throws SqlStatementBuilderException {
		...
		return new SqlInsertColumns6<>(next, this.column1, this.column2, this.column3, this.column4, this.column5, this.column6);
	}
