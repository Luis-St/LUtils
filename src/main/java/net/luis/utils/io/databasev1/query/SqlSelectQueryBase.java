...
import net.luis.utils.io.databasev1.condition.SqlOrderable;
import net.luis.utils.io.databasev1.exception.SqlException;
import net.luis.utils.io.databasev1.exception.entity.SqlEntityNotFoundException;
import net.luis.utils.io.databasev1.exception.query.SqlQueryException;
...
public interface SqlSelectQueryBase<T, Q extends SqlSelectQueryBase<T, Q>> extends SqlRenderable, SqlJoinable<Q> {
	 ...
	 * Requires {@link net.luis.utils.io.databasev1.dialect.SqlFeature#LATERAL} dialect support.<br>
