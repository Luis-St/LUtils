...
/**
 * Represents a codec grouping function that accepts eleven arguments and produces a result.<br>
 ...
 */
@FunctionalInterface
public interface CodecBuilderFunction11<CI1, CI2, CI3, CI4, CI5, CI6, CI7, CI8, CI9, CI10, CI11, R> extends CodecBuilderFunction {
