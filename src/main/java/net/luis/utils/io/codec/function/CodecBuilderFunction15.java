...
/**
 * Represents a codec grouping function that accepts fifteen arguments and produces a result.<br>
 ...
 */
@FunctionalInterface
public interface CodecBuilderFunction15<CI1, CI2, CI3, CI4, CI5, CI6, CI7, CI8, CI9, CI10, CI11, CI12, CI13, CI14, CI15, R> extends CodecBuilderFunction {
