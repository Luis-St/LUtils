 ...
 */
@ApiStatus.Internal
public class UnionCodec<C> implements Codec<C> {
	 ...
	 * @param validValues The array of valid values that can be encoded or decoded
	 * @throws NullPointerException if codec or validValues is null
	 * @throws IllegalArgumentException if validValues is empty
	 */
	@SafeVarargs
	public UnionCodec(@NotNull Codec<C> codec, @NotNull C... validValues) {
		this(codec, Arrays.asList(validValues));
	}
