 ...
 * @author Luis-St
 */
public class DoubleCodec implements KeyableCodec<Double> {
	...
	@Override
	public @NotNull <R> Result<String> encodeKey(@NotNull TypeProvider<R> provider, @NotNull Double key) {
		Objects.requireNonNull(provider, "Type provider must not be null");
	...
	@Override
	public @NotNull <R> Result<Double> decodeKey(@NotNull TypeProvider<R> provider, @NotNull String key) {
		Objects.requireNonNull(provider, "Type provider must not be null");
		Objects.requireNonNull(key, "Key must not be null");
