 ...
 *     comprehensive set size validation capabilities.<br>
 ...
 */
@FunctionalInterface
public interface SetConstraint<C> extends ApplicableConstraint<SizeConstraintConfig, C>, SizeConstraint<Integer, C> {
