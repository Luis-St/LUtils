...
public record CodecGrouper11<CI1, CI2, CI3, CI4, CI5, CI6, CI7, CI8, CI9, CI10, CI11>(
	...
	public <R> @NotNull Codec<R> create(@NotNull CodecGroupingFunction11<CI1, CI2, CI3, CI4, CI5, CI6, CI7, CI8, CI9, CI10, CI11, R> function) {
		return null;
	}
}
