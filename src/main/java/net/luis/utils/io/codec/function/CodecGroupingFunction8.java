...
/**
 * Represents a codec grouping function that accepts eight arguments and produces a result.<br>
 ...
 */
@FunctionalInterface
public interface CodecGroupingFunction8<CI1, CI2, CI3, CI4, CI5, CI6, CI7, CI8, R> extends CodecGroupingFunction {
