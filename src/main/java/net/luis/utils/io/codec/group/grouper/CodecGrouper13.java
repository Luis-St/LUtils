...
/**
 * Represents a group of thirteen codecs.<br>
 ...
 */
public record CodecGrouper13<CI1, CI2, CI3, CI4, CI5, CI6, CI7, CI8, CI9, CI10, CI11, CI12, CI13, O>(
	...
	public @NotNull Codec<O> create(@NotNull CodecGroupingFunction13<CI1, CI2, CI3, CI4, CI5, CI6, CI7, CI8, CI9, CI10, CI11, CI12, CI13, O> function) {
		...
		return new Codec<>() {
			...
			public @NotNull <R> Result<O> decodeStart(@NotNull TypeProvider<R> provider, @Nullable R value) {
				...
				return Result.success(function.create(
					...
					decoded9.orThrow(), decoded10.orThrow(), decoded11.orThrow(), decoded12.orThrow(), decoded13.orThrow()
				));
			}
			...
			public String toString() {
				return "Codec[" + codec1 + ", " + codec2 + ", " + codec3 + ", " + codec4 + ", " + codec5 + ", " + codec6 + ", " + codec7 + ", " + codec8 + ", "
					+ codec9 + ", " + codec10 + ", " + codec11 + ", " + codec12 + ", " + codec13 + ", " + "]";
			}
		};
	}
}
