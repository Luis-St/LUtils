...
/**
 * Represents a codec grouping function that accepts six arguments and produces a result.<br>
 ...
 */
@FunctionalInterface
public interface CodecGroupingFunction6<CI1, CI2, CI3, CI4, CI5, CI6, R> extends CodecGroupingFunction {
