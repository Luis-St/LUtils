...
/**
 * Constraint interface for IpAddress types that provides comprehensive IP address validation operations.<br>
 * <p>
 *     This interface extends {@link ApplicableConstraint} and {@link BaseConstraint} with methods for constraining IpAddresses
 ...
 */
@FunctionalInterface
public interface IpAddressConstraint<C> extends ApplicableConstraint<IpAddressConstraintConfig, C>, BaseConstraint<IpAddress<?>, C> {
	
	@Override
	@NonNull C apply(@NonNull UnaryOperator<IpAddressConstraintConfig> configModifier);
	
	@Override
	default @NonNull C equalTo(@NonNull IpAddress<?> value) {
		return this.apply(config -> config.withEqualTo(value));
	}
	
	@Override
	default @NonNull C notEqualTo(@NonNull IpAddress<?> value) {
		return this.apply(config -> config.withNotEqualTo(value));
	}
	
	@Override
	default @NonNull C in(@NonNull Collection<IpAddress<?>> values) {
		return this.apply(config -> config.withIn(values));
	}
	
	@Override
	default @NonNull C notIn(@NonNull Collection<IpAddress<?>> values) {
		return this.apply(config -> config.withNotIn(values));
	}
	
	@Override
	default @NonNull C custom(@NonNull Constraint<IpAddress<?>> constraint) {
		return this.apply(config -> config.withCustom(constraint));
	}
	
	/**
	 * Applies an IP version constraint to the IpAddress.<br>
	 * <p>
	 *     The returned type will validate that the IpAddress matches the IP version constraints defined by the config.
	 * </p>
	 *
	...
	/**
	 * Applies an IPv4 constraint to the IpAddress.<br>
	 * <p>
	 *     The returned type will validate that the IpAddress is an IPv4 address.
	 * </p>
	 *
	...
	/**
	 * Applies an IPv6 constraint to the IpAddress.<br>
	 * <p>
	 *     The returned type will validate that the IpAddress is an IPv6 address.
	 * </p>
	 *
	...
	/**
	 * Applies an IP address type constraint to the IpAddress.<br>
	 * <p>
	 *     The returned type will validate that the IpAddress matches the IP address type constraints defined by the config.
	 * </p>
	 *
	...
	/**
	 * Applies a public address constraint to the IpAddress.<br>
	 * <p>
	 *     The returned type will validate that the IpAddress is a public (globally routable) address.
	 * </p>
	 *
	...
	/**
	 * Applies a private address constraint to the IpAddress.<br>
	 * <p>
	 *     The returned type will validate that the IpAddress is a private (non-routable) address.
	 * </p>
	 *
	...
	/**
	 * Applies a loopback address constraint to the IpAddress.<br>
	 * <p>
	 *     The returned type will validate that the IpAddress is a loopback address (127.0.0.1 or ::1).
	 * </p>
	 *
	...
	/**
	 * Applies a link-local address constraint to the IpAddress.<br>
	 * <p>
	 *     The returned type will validate that the IpAddress is a link-local address.
	 * </p>
	 *
	...
	/**
	 * Applies a multicast address constraint to the IpAddress.<br>
	 * <p>
	 *     The returned type will validate that the IpAddress is a multicast address.
	 * </p>
	 *
	...
	/**
	 * Applies a subnet membership constraint to the IpAddress.<br>
	 * <p>
	 *     The returned type will validate that the IpAddress is a member of at least one of the specified subnets.
	 * </p>
	 *
	...
	/**
	 * Applies an excluded subnet constraint to the IpAddress.<br>
	 * <p>
	 *     The returned type will validate that the IpAddress is not a member of any of the specified subnets.
	 * </p>
	 *
	...
	/**
	 * Applies string constraints to the IP address string representation using a builder.<br>
	 * <p>
	 *     The returned type will validate that the string representation of the IpAddress matches
	 *     the constraints defined by the builder configuration.<br>
	 *     Example usage: {@code .string(b -> b.startsWith("192.168.").length(l -> l.maxLength(15)))}
	 * </p>
	 *
