 ...
 * @author Luis-St
 */
public class ByteArrayCodec extends AbstractCodec<byte[], Object> {
	...
	@Override
	public <R> @NotNull Result<R> encodeStart(@NotNull TypeProvider<R> provider, @NotNull R current, byte @Nullable [] value) {
