...
public class BigIntegerCodec extends AbstractCodec<BigInteger, Object> {
	...
	@Override
	public <R> @NotNull Result<R> encodeStart(@NotNull TypeProvider<R> provider, @NotNull R current, @Nullable BigInteger value) {
	...
	@Override
	public @NotNull Result<String> encodeKey(@NotNull BigInteger key) {
		Objects.requireNonNull(key, "Key must not be null");
		return Result.success(key.toString());
	}

	@Override
	public <R> @NotNull Result<BigInteger> decodeStart(@NotNull TypeProvider<R> provider, @NotNull R current, @Nullable R value) {
		Objects.requireNonNull(provider, "Type provider must not be null");
		Objects.requireNonNull(current, "Current value must not be null");
		if (value == null) {
	...
	@Override
	public @NotNull Result<BigInteger> decodeKey(@NotNull String key) {
		Objects.requireNonNull(key, "Key must not be null");
