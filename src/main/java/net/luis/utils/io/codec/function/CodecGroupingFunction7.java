...
/**
 * Represents a codec grouping function that accepts seven arguments and produces a result.<br>
 ...
 */
@FunctionalInterface
public interface CodecGroupingFunction7<CI1, CI2, CI3, CI4, CI5, CI6, CI7, R> extends CodecGroupingFunction {
