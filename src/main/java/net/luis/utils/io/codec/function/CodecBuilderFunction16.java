...
/**
 * Represents a codec grouping function that accepts sixteen arguments and produces a result.<br>
 ...
 * @param <CI15> The type of the fifteenth input
 * @param <CI16> The type of the sixteenth input
 * @param <R> The result type
 */
@FunctionalInterface
public interface CodecBuilderFunction16<CI1, CI2, CI3, CI4, CI5, CI6, CI7, CI8, CI9, CI10, CI11, CI12, CI13, CI14, CI15, CI16, R> extends CodecBuilderFunction {
	 ...
	 * @param input15 The fifteenth input
	 * @param input16 The sixteenth input
	...
	@NonNull R create(
		...
		@NonNull CI8 input8,
		@NonNull CI9 input9,
		@NonNull CI10 input10,
		@NonNull CI11 input11,
		@NonNull CI12 input12,
		@NonNull CI13 input13,
		@NonNull CI14 input14,
		@NonNull CI15 input15,
		@NonNull CI16 input16
	);
}
