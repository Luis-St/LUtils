...
public class OffsetDateTimeCodec extends AbstractCodec<OffsetDateTime, Object> {
	...
	@Override
	public <R> @NotNull Result<R> encodeStart(@NotNull TypeProvider<R> provider, @NotNull R current, @Nullable OffsetDateTime value) {
	...
	@Override
	public @NotNull Result<String> encodeKey(@NotNull OffsetDateTime key) {
		Objects.requireNonNull(key, "Key must not be null");
		return Result.success(key.toString());
	}
	
	@Override
	public <R> @NotNull Result<OffsetDateTime> decodeStart(@NotNull TypeProvider<R> provider, @NotNull R current, @Nullable R value) {
		Objects.requireNonNull(provider, "Type provider must not be null");
		Objects.requireNonNull(current, "Current value must not be null");
		if (value == null) {
	...
	@Override
	public @NotNull Result<OffsetDateTime> decodeKey(@NotNull String key) {
		Objects.requireNonNull(key, "Key must not be null");
		try {
