...
public record CodecGrouper8<CI1, CI2, CI3, CI4, CI5, CI6, CI7, CI8>(
	...
	public <R> @NotNull Codec<R> create(@NotNull CodecGroupingFunction8<CI1, CI2, CI3, CI4, CI5, CI6, CI7, CI8, R> function) {
		return null;
	}
}
