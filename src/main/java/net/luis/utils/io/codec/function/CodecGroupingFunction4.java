...
/**
 * Represents a codec grouping function that accepts four arguments and produces a result.<br>
 ...
 */
@FunctionalInterface
public interface CodecGroupingFunction4<CI1, CI2, CI3, CI4, R> extends CodecGroupingFunction {
