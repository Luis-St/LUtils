 ...
 * @author Luis-St
 *
 * @param equalTo The exact Instant that should be matched
 * @param notEqualTo The Instant that should be excluded
 * @param in The set of Instants that are allowed
 * @param notIn The set of Instants that are not allowed
...
public record InstantConstraintConfig(
	@NonNull Optional<Instant> equalTo,
	@NonNull Optional<Instant> notEqualTo,
	@NonNull Optional<Set<Instant>> in,
	@NonNull Optional<Set<Instant>> notIn,
	...
	public @NonNull InstantConstraintConfig withEqualTo(@NonNull Instant value) {
		return new InstantConstraintConfig(Optional.of(Objects.requireNonNull(value)), this.notEqualTo, this.in, this.notIn, this.after, this.before, this.withinLast, this.withinNext, this.custom);
	}
	...
	public @NonNull InstantConstraintConfig withNotEqualTo(@NonNull Instant value) {
		return new InstantConstraintConfig(this.equalTo, Optional.of(Objects.requireNonNull(value)), this.in, this.notIn, this.after, this.before, this.withinLast, this.withinNext, this.custom);
	}
	...
	public @NonNull InstantConstraintConfig withIn(@NonNull Collection<Instant> values) {
		return new InstantConstraintConfig(this.equalTo, this.notEqualTo, Optional.of(Set.copyOf(values)), this.notIn, this.after, this.before, this.withinLast, this.withinNext, this.custom);
	}
	...
	public @NonNull InstantConstraintConfig withNotIn(@NonNull Collection<Instant> values) {
		return new InstantConstraintConfig(this.equalTo, this.notEqualTo, this.in, Optional.of(Set.copyOf(values)), this.after, this.before, this.withinLast, this.withinNext, this.custom);
	}
	...
	public @NonNull InstantConstraintConfig withAfter(@NonNull Instant value) {
		return new InstantConstraintConfig(this.equalTo, this.notEqualTo, this.in, this.notIn, Optional.of(Pair.of(Objects.requireNonNull(value), false)), this.before, this.withinLast, this.withinNext, this.custom);
	}
	...
	public @NonNull InstantConstraintConfig withAfterOrEqual(@NonNull Instant value) {
		return new InstantConstraintConfig(this.equalTo, this.notEqualTo, this.in, this.notIn, Optional.of(Pair.of(Objects.requireNonNull(value), true)), this.before, this.withinLast, this.withinNext, this.custom);
	}
	...
	public @NonNull InstantConstraintConfig withBefore(@NonNull Instant value) {
		return new InstantConstraintConfig(this.equalTo, this.notEqualTo, this.in, this.notIn, this.after, Optional.of(Pair.of(Objects.requireNonNull(value), false)), this.withinLast, this.withinNext, this.custom);
	}
	...
	public @NonNull InstantConstraintConfig withBeforeOrEqual(@NonNull Instant value) {
		return new InstantConstraintConfig(this.equalTo, this.notEqualTo, this.in, this.notIn, this.after, Optional.of(Pair.of(Objects.requireNonNull(value), true)), this.withinLast, this.withinNext, this.custom);
	}
	...
	public @NonNull InstantConstraintConfig withBetween(@NonNull Instant after, @NonNull Instant before) {
		return new InstantConstraintConfig(this.equalTo, this.notEqualTo, this.in, this.notIn, Optional.of(Pair.of(Objects.requireNonNull(after), false)), Optional.of(Pair.of(Objects.requireNonNull(before), false)), this.withinLast, this.withinNext, this.custom);
	}
	...
	public @NonNull InstantConstraintConfig withBetweenOrEqual(@NonNull Instant after, @NonNull Instant before) {
		return new InstantConstraintConfig(this.equalTo, this.notEqualTo, this.in, this.notIn, Optional.of(Pair.of(Objects.requireNonNull(after), true)), Optional.of(Pair.of(Objects.requireNonNull(before), true)), this.withinLast, this.withinNext, this.custom);
	}
	...
	public @NonNull InstantConstraintConfig withWithinLast(@NonNull Duration duration) {
		return new InstantConstraintConfig(this.equalTo, this.notEqualTo, this.in, this.notIn, this.after, this.before, Optional.of(Objects.requireNonNull(duration)), this.withinNext, this.custom);
	}
	...
	public @NonNull InstantConstraintConfig withWithinNext(@NonNull Duration duration) {
		return new InstantConstraintConfig(this.equalTo, this.notEqualTo, this.in, this.notIn, this.after, this.before, this.withinLast, Optional.of(Objects.requireNonNull(duration)), this.custom);
	}
	...
	public @NonNull InstantConstraintConfig withCustom(@NonNull Constraint<Instant> constraint) {
		return new InstantConstraintConfig(this.equalTo, this.notEqualTo, this.in, this.notIn, this.after, this.before, this.withinLast, this.withinNext, Optional.of(Objects.requireNonNull(constraint)));
	}
}
