 ...
 * <p>
 *     This class holds constraint configuration for {@link OffsetDateTime} values.
 * </p>
 *
 * @author Luis-St
 */
...
public record OffsetDateTimeConstraintConfig(
	@NonNull Optional<Pair<OffsetDateTime, Boolean>> min,
	@NonNull Optional<Pair<OffsetDateTime, Boolean>> max,
	@NonNull Optional<Pair<OffsetDateTime, Boolean>> equals,
...
) implements TemporalConstraintConfigProvider<OffsetDateTime, OffsetDateTimeConstraintConfig>, TimeFieldConstraintConfigProvider<OffsetDateTimeConstraintConfig>, DateFieldConstraintConfigProvider<OffsetDateTimeConstraintConfig> {
	...
	public OffsetDateTimeConstraintConfig {
		...
		if (min.isPresent() && max.isPresent()) {
			Pair<OffsetDateTime, Boolean> minPair = min.get();
			Pair<OffsetDateTime, Boolean> maxPair = max.get();
	...
	public @NonNull OffsetDateTimeConstraintConfig withEquals(@NonNull OffsetDateTime value, boolean negated) {
		return new OffsetDateTimeConstraintConfig(this.min, this.max, Optional.of(Pair.of(value, negated)), this.withinLast, this.withinNext, this.hour, this.minute, this.second, this.millisecond, this.daysOfWeek, this.dayOfMonth, this.months, this.year);
	}

	@Override
	public @NonNull OffsetDateTimeConstraintConfig withMin(@NonNull OffsetDateTime min, boolean inclusive) {
		return new OffsetDateTimeConstraintConfig(Optional.of(Pair.of(min, inclusive)), this.max, this.equals, this.withinLast, this.withinNext, this.hour, this.minute, this.second, this.millisecond, this.daysOfWeek, this.dayOfMonth, this.months, this.year);
	}

	@Override
	public @NonNull OffsetDateTimeConstraintConfig withMax(@NonNull OffsetDateTime max, boolean inclusive) {
		return new OffsetDateTimeConstraintConfig(this.min, Optional.of(Pair.of(max, inclusive)), this.equals, this.withinLast, this.withinNext, this.hour, this.minute, this.second, this.millisecond, this.daysOfWeek, this.dayOfMonth, this.months, this.year);
	}
	...
	public @NonNull OffsetDateTimeConstraintConfig withRange(@NonNull OffsetDateTime min, @NonNull OffsetDateTime max, boolean inclusive) {
		return new OffsetDateTimeConstraintConfig(Optional.of(Pair.of(min, inclusive)), Optional.of(Pair.of(max, inclusive)), this.equals, this.withinLast, this.withinNext, this.hour, this.minute, this.second, this.millisecond, this.daysOfWeek, this.dayOfMonth, this.months, this.year);
	}

	@Override
	public @NonNull OffsetDateTimeConstraintConfig withWithinLast(@NonNull Duration duration) {
		return new OffsetDateTimeConstraintConfig(this.min, this.max, this.equals, Optional.of(duration), this.withinNext, this.hour, this.minute, this.second, this.millisecond, this.daysOfWeek, this.dayOfMonth, this.months, this.year);
	}

	@Override
	public @NonNull OffsetDateTimeConstraintConfig withWithinNext(@NonNull Duration duration) {
		return new OffsetDateTimeConstraintConfig(this.min, this.max, this.equals, this.withinLast, Optional.of(duration), this.hour, this.minute, this.second, this.millisecond, this.daysOfWeek, this.dayOfMonth, this.months, this.year);
	}

	@Override
	public @NonNull OffsetDateTimeConstraintConfig withHour(@NonNull FieldConstraintConfig hourConfig) {
		return new OffsetDateTimeConstraintConfig(this.min, this.max, this.equals, this.withinLast, this.withinNext, Optional.of(hourConfig), this.minute, this.second, this.millisecond, this.daysOfWeek, this.dayOfMonth, this.months, this.year);
	}

	@Override
	public @NonNull OffsetDateTimeConstraintConfig withMinute(@NonNull FieldConstraintConfig minuteConfig) {
		return new OffsetDateTimeConstraintConfig(this.min, this.max, this.equals, this.withinLast, this.withinNext, this.hour, Optional.of(minuteConfig), this.second, this.millisecond, this.daysOfWeek, this.dayOfMonth, this.months, this.year);
	}

	@Override
	public @NonNull OffsetDateTimeConstraintConfig withSecond(@NonNull FieldConstraintConfig secondConfig) {
		return new OffsetDateTimeConstraintConfig(this.min, this.max, this.equals, this.withinLast, this.withinNext, this.hour, this.minute, Optional.of(secondConfig), this.millisecond, this.daysOfWeek, this.dayOfMonth, this.months, this.year);
	}

	@Override
	public @NonNull OffsetDateTimeConstraintConfig withMillisecond(@NonNull FieldConstraintConfig millisecondConfig) {
		return new OffsetDateTimeConstraintConfig(this.min, this.max, this.equals, this.withinLast, this.withinNext, this.hour, this.minute, this.second, Optional.of(millisecondConfig), this.daysOfWeek, this.dayOfMonth, this.months, this.year);
	}

	@Override
	public @NonNull OffsetDateTimeConstraintConfig withDayOfWeek(@NonNull Set<DayOfWeek> daysOfWeek) {
		return new OffsetDateTimeConstraintConfig(this.min, this.max, this.equals, this.withinLast, this.withinNext, this.hour, this.minute, this.second, this.millisecond, Optional.of(Set.copyOf(daysOfWeek)), this.dayOfMonth, this.months, this.year);
	}

	@Override
	public @NonNull OffsetDateTimeConstraintConfig withDayOfMonth(@NonNull FieldConstraintConfig monthConfig) {
		return new OffsetDateTimeConstraintConfig(this.min, this.max, this.equals, this.withinLast, this.withinNext, this.hour, this.minute, this.second, this.millisecond, this.daysOfWeek, Optional.of(monthConfig), this.months, this.year);
	}

	@Override
	public @NonNull OffsetDateTimeConstraintConfig withMonth(@NonNull Set<Month> months) {
		return new OffsetDateTimeConstraintConfig(this.min, this.max, this.equals, this.withinLast, this.withinNext, this.hour, this.minute, this.second, this.millisecond, this.daysOfWeek, this.dayOfMonth, Optional.of(Set.copyOf(months)), this.year);
	}

	@Override
	public @NonNull OffsetDateTimeConstraintConfig withYear(@NonNull FieldConstraintConfig yearConfig) {
		return new OffsetDateTimeConstraintConfig(this.min, this.max, this.equals, this.withinLast, this.withinNext, this.hour, this.minute, this.second, this.millisecond, this.daysOfWeek, this.dayOfMonth, this.months, Optional.of(yearConfig));
	}
	...
	public @NonNull Result<Void> matches(@NonNull OffsetDateTime value) {
		...
		if (this.isUnconstrained()) return Result.success();

		if (this.equals.isPresent()) {
			Pair<OffsetDateTime, Boolean> pair = this.equals.get();
			if (pair.getSecond()) {
		...
		if (this.min.isPresent()) {
			Pair<OffsetDateTime, Boolean> pair = this.min.get();
		...
		if (this.max.isPresent()) {
			Pair<OffsetDateTime, Boolean> pair = this.max.get();
			int comparison = value.compareTo(pair.getFirst());
			if (pair.getSecond()) {
				if (comparison > 0) {
