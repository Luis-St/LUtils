 ...
 * @author Luis-St
 */
public class BooleanCodec implements KeyableCodec<Boolean> {
	...
	@Override
	public @NotNull <R> Result<String> encodeKey(@NotNull TypeProvider<R> provider, @NotNull Boolean key) {
		Objects.requireNonNull(provider, "Type provider must not be null");
	...
	@Override
	public @NotNull <R> Result<Boolean> decodeKey(@NotNull TypeProvider<R> provider, @NotNull String key) {
		Objects.requireNonNull(provider, "Type provider must not be null");
		Objects.requireNonNull(key, "Key must not be null");
