...
public record CodecGrouper9<CI1, CI2, CI3, CI4, CI5, CI6, CI7, CI8, CI9>(
	...
	public <R> @NotNull Codec<R> create(@NotNull CodecGroupingFunction9<CI1, CI2, CI3, CI4, CI5, CI6, CI7, CI8, CI9, R> function) {
		return null;
	}
}
