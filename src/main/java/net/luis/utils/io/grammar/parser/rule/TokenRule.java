...
import net.luis.utils.io.grammar.parser.TokenRuleMatch;
import net.luis.utils.io.grammar.parser.context.TokenRuleContext;
...
import net.luis.utils.io.grammar.parser.stream.TokenStream;
...
public interface TokenRule {
	 ...
	 * A token group rule applies this rule to the tokens within a {@link TokenGroup}<br>
