...
package net.luis.utils.io.grammar.parser;

import com.google.common.collect.Lists;
import net.luis.utils.io.grammar.parser.action.GroupingTokenAction;
import net.luis.utils.io.grammar.parser.action.TokenAction;
import net.luis.utils.io.grammar.parser.action.core.GroupingMode;
import net.luis.utils.io.grammar.parser.context.TokenRuleContext;
import net.luis.utils.io.grammar.parser.rule.*;
import net.luis.utils.io.grammar.parser.rule.combinators.AnyOfTokenRule;
...
public class ParserBuilder {
	 ...
	 * Use {@link Parser#builder(Consumer)} to create a parser.<br>
	 */
	ParserBuilder() {}
	 ...
	 * The rule is paired with a {@link GroupingTokenAction} that wraps the matched tokens into a {@link TokenGroup} labeled with the rule name.<br>
	 *
