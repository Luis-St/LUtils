...
package net.luis.utils.io.grammar.lexer.rule;

import net.luis.utils.io.grammar.lexer.rule.anchors.EndCharRule;
import net.luis.utils.io.grammar.lexer.rule.anchors.StartCharRule;
import net.luis.utils.io.grammar.lexer.rule.combinators.CharAnyOfRule;
import net.luis.utils.io.grammar.lexer.rule.combinators.CharSequenceRule;
import net.luis.utils.io.grammar.lexer.rule.matchers.*;
import net.luis.utils.io.grammar.lexer.rule.quantifiers.CharOptionalRule;
import net.luis.utils.io.grammar.lexer.rule.quantifiers.CharRepeatedRule;
import net.luis.utils.io.grammar.token.EscapedToken;
...
public final class CharRules {
	 ...
	 * When used in a lexer rule, the produced token is an {@link EscapedToken}.<br>
	 *
	 * @return The created character rule
