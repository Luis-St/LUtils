...
package net.luis.utils.io.grammar.parser.rule;

import net.luis.utils.io.grammar.parser.rule.assertions.LookaheadTokenRule;
import net.luis.utils.io.grammar.parser.rule.assertions.LookbehindTokenRule;
import net.luis.utils.io.grammar.parser.rule.assertions.anchors.EndTokenRule;
import net.luis.utils.io.grammar.parser.rule.assertions.anchors.StartTokenRule;
import net.luis.utils.io.grammar.parser.rule.combinators.*;
import net.luis.utils.io.grammar.parser.rule.core.LookMatchMode;
import net.luis.utils.io.grammar.parser.rule.core.ReferenceType;
import net.luis.utils.io.grammar.parser.rule.matchers.*;
import net.luis.utils.io.grammar.parser.rule.quantifiers.OptionalTokenRule;
import net.luis.utils.io.grammar.parser.rule.quantifiers.RepeatedTokenRule;
import net.luis.utils.io.grammar.parser.rule.reference.CaptureTokenRule;
import net.luis.utils.io.grammar.parser.rule.reference.ReferenceTokenRule;
import net.luis.utils.io.grammar.token.Token;
import net.luis.utils.io.grammar.token.TokenGroup;
...
public final class TokenRules {
	 ...
	 * This rule matches if the token at the current position is a {@link TokenGroup}
