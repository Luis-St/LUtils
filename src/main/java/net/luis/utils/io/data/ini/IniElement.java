...
public interface IniElement {
	 ...
	 */
	default boolean isIniBoolean() {
		return this.isIniValue() && this.getAsIniValue().isIniBoolean();
	}
	 ...
	 */
	default boolean isIniNumber() {
		return this.isIniValue() && this.getAsIniValue().isIniNumber();
	}
	 ...
	 */
	default boolean isIniByte() {
		return this.isIniValue() && this.getAsIniValue().isIniByte();
	}
	 ...
	 */
	default boolean isIniShort() {
		return this.isIniValue() && this.getAsIniValue().isIniShort();
	}
	 ...
	 */
	default boolean isIniInteger() {
		return this.isIniValue() && this.getAsIniValue().isIniInteger();
	}
	 ...
	 */
	default boolean isIniLong() {
		return this.isIniValue() && this.getAsIniValue().isIniLong();
	}
	 ...
	 */
	default boolean isIniFloat() {
		return this.isIniValue() && this.getAsIniValue().isIniFloat();
	}
	 ...
	 */
	default boolean isIniDouble() {
		return this.isIniValue() && this.getAsIniValue().isIniDouble();
	}
	 ...
	 */
	default boolean isIniString() {
		return this.isIniValue() && this.getAsIniValue().isIniString();
	}
